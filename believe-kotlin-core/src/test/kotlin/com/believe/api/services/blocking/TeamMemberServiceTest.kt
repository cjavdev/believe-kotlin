...
internal class TeamMemberServiceTest {
    ...
    fun create() {
      ...
      val teamMember = teamMemberService.create(TeamMemberCreateParams.Member.Player.builder()
    ...
    fun update() {
      ...
      val teamMember = teamMemberService.update(TeamMemberUpdateParams.builder()
          .memberId("member_id")
