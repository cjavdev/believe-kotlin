...
internal class MatchServiceTest {
    ...
    fun create() {
      ...
      val match = matchService.create(MatchCreateParams.builder()
    ...
    fun update() {
      ...
      val match = matchService.update(MatchUpdateParams.builder()
          .matchId("match_id")
          .attendance(0L)
          .awayScore(0L)
    ...
    fun streamLive() {
      ...
      matchService.streamLive(MatchStreamLiveParams.builder()
          .awayTeam("away_team")
          .excitementLevel(1L)
          .homeTeam("home_team")
          .speed(0.1)
