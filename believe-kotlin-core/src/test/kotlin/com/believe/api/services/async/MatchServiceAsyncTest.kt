...
internal class MatchServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val match = matchServiceAsync.create(MatchCreateParams.builder()
    ...
    suspend fun update() {
      ...
      val match = matchServiceAsync.update(MatchUpdateParams.builder()
          .matchId("match_id")
          .attendance(0L)
          .awayScore(0L)
    ...
    suspend fun streamLive() {
      ...
      matchServiceAsync.streamLive(MatchStreamLiveParams.builder()
          .awayTeam("away_team")
          .excitementLevel(1L)
          .homeTeam("home_team")
          .speed(0.1)
