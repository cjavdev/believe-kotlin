...
internal class QuoteServiceTest {
    ...
    fun create() {
      ...
      val quote = quoteService.create(QuoteCreateParams.builder()
    ...
    fun update() {
      ...
      val quote = quoteService.update(QuoteUpdateParams.builder()
          .quoteId("quote_id")
    ...
    fun getRandom() {
      ...
      val quote = quoteService.getRandom(QuoteGetRandomParams.builder()
          .characterId("character_id")
          .inspirational(true)
          .theme(QuoteTheme.BELIEF)
          .build())
