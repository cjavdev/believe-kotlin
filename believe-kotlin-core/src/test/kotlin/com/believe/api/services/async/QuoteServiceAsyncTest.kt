...
internal class QuoteServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val quote = quoteServiceAsync.create(QuoteCreateParams.builder()
    ...
    suspend fun update() {
      ...
      val quote = quoteServiceAsync.update(QuoteUpdateParams.builder()
          .quoteId("quote_id")
    ...
    suspend fun getRandom() {
      ...
      val quote = quoteServiceAsync.getRandom(QuoteGetRandomParams.builder()
          .characterId("character_id")
          .inspirational(true)
          .theme(QuoteTheme.BELIEF)
          .build())
