...
internal class TeamMemberListPageResponseTest {
    ...
    @Test
    fun create() {
      val teamMemberListPageResponse = TeamMemberListPageResponse.builder()
      ...
      assertThat(teamMemberListPageResponse.data()).containsExactly(TeamMemberListResponse.ofPlayer(Player.builder()
          .id("jamie-tartt-richmond")
          .characterId("jamie-tartt")
          .jerseyNumber(9L)
          .position(Position.FORWARD)
    ...
    fun roundtrip() {
      ...
      val roundtrippedTeamMemberListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(teamMemberListPageResponse), jacksonTypeRef<TeamMemberListPageResponse>())
