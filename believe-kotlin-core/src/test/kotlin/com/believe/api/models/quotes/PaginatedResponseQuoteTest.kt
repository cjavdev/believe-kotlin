...
internal class PaginatedResponseQuoteTest {
    ...
    @Test
    fun create() {
      val paginatedResponseQuote = PaginatedResponseQuote.builder()
          .addData(Quote.builder()
              .id("quote-001")
      ...
      assertThat(paginatedResponseQuote.data()).containsExactly(Quote.builder()
          .id("quote-001")
          .characterId("ted-lasso")
          .context("Ted playing darts against Rupert in the pub, explaining his philosophy")
          .momentType(QuoteMoment.PUB)
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaginatedResponseQuote = jsonMapper.readValue(jsonMapper.writeValueAsString(paginatedResponseQuote), jacksonTypeRef<PaginatedResponseQuote>())
