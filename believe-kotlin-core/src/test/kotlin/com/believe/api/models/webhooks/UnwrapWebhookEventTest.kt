...
internal class UnwrapWebhookEventTest {
    ...
    fun ofMatchCompleted() {
      val matchCompleted = MatchCompletedWebhookEvent.builder()
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .data(MatchCompletedWebhookEvent.Data.builder()
              .awayScore(0L)
    ...
    fun ofMatchCompletedRoundtrip() {
      ...
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofMatchCompleted(MatchCompletedWebhookEvent.builder()
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .data(MatchCompletedWebhookEvent.Data.builder()
              .awayScore(0L)
              .awayTeamId("away_team_id")
      ...
      val roundtrippedUnwrapWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(unwrapWebhookEvent), jacksonTypeRef<UnwrapWebhookEvent>())
    ...
    fun ofTeamMemberTransferred() {
      val teamMemberTransferred = TeamMemberTransferredWebhookEvent.builder()
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun ofTeamMemberTransferredRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofTeamMemberTransferred(TeamMemberTransferredWebhookEvent.builder()
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .data(TeamMemberTransferredWebhookEvent.Data.builder()
              .characterId("character_id")
              .characterName("character_name")
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
      val unwrapWebhookEvent = jsonMapper().convertValue(testCase.value, jacksonTypeRef<UnwrapWebhookEvent>())

      val e = assertThrows<BelieveInvalidDataException> {
        unwrapWebhookEvent.validate()
      }
