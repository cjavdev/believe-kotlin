...
internal class TeamMemberListResponseTest {
    ...
    fun ofPlayerRoundtrip() {
      ...
      val teamMemberListResponse = TeamMemberListResponse.ofPlayer(Player.builder()
          .id("jamie-tartt-richmond")
          .characterId("jamie-tartt")
          .jerseyNumber(9L)
          .position(Position.FORWARD)
      ...
      val roundtrippedTeamMemberListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(teamMemberListResponse), jacksonTypeRef<TeamMemberListResponse>())
    ...
    fun ofCoachRoundtrip() {
      val jsonMapper = jsonMapper()
      val teamMemberListResponse = TeamMemberListResponse.ofCoach(Coach.builder()
          .id("ted-lasso-richmond")
          .characterId("ted-lasso")
          .specialty(CoachSpecialty.HEAD_COACH)
          .teamId("afc-richmond")
    ...
    fun ofMedicalStaffRoundtrip() {
      val jsonMapper = jsonMapper()
      val teamMemberListResponse = TeamMemberListResponse.ofMedicalStaff(MedicalStaff.builder()
          .id("sharon-fieldstone-richmond")
          .characterId("dr-sharon")
          .specialty(MedicalSpecialty.SPORTS_PSYCHOLOGIST)
          .teamId("afc-richmond")
    ...
    fun ofEquipmentManagerRoundtrip() {
      val jsonMapper = jsonMapper()
      val teamMemberListResponse = TeamMemberListResponse.ofEquipmentManager(EquipmentManager.builder()
          .id("nate-kitman-richmond")
          .characterId("nathan-shelley")
          .teamId("afc-richmond")
          .yearsWithTeam(5L)
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
      val teamMemberListResponse = jsonMapper().convertValue(testCase.value, jacksonTypeRef<TeamMemberListResponse>())

      val e = assertThrows<BelieveInvalidDataException> {
        teamMemberListResponse.validate()
      }
