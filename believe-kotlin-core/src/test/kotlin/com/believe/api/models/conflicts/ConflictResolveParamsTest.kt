...
internal class ConflictResolveParamsTest {
    ...
    @Test
    fun body() {
      val params = ConflictResolveParams.builder()
          .conflictType(ConflictResolveParams.ConflictType.INTERPERSONAL)
          .description("Alex keeps taking credit for my ideas in meetings and I'm getting resentful.")
          .addPartiesInvolved("Me")
          .addPartiesInvolved("My teammate Alex")
      ...
      assertThat(body.description()).isEqualTo("Alex keeps taking credit for my ideas in meetings and I'm getting resentful.")
