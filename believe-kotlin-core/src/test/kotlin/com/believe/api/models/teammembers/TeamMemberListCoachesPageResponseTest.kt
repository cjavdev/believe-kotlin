...
internal class TeamMemberListCoachesPageResponseTest {
    ...
    @Test
    fun create() {
      val teamMemberListCoachesPageResponse = TeamMemberListCoachesPageResponse.builder()
          .addData(Coach.builder()
      ...
      assertThat(teamMemberListCoachesPageResponse.data()).containsExactly(Coach.builder()
          .id("ted-lasso-richmond")
          .characterId("ted-lasso")
          .specialty(CoachSpecialty.HEAD_COACH)
          .teamId("afc-richmond")
    ...
    fun roundtrip() {
      ...
      val roundtrippedTeamMemberListCoachesPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(teamMemberListCoachesPageResponse), jacksonTypeRef<TeamMemberListCoachesPageResponse>())

      assertThat(roundtrippedTeamMemberListCoachesPageResponse).isEqualTo(teamMemberListCoachesPageResponse)
    }
}
