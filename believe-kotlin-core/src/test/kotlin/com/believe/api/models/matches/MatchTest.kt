...
internal class MatchTest {
    ...
    fun create() {
      ...
      assertThat(match.lessonLearned()).isEqualTo("Sometimes a tie feels like a win when you've grown as people.")
      assertThat(match.possessionPercentage()).isEqualTo(52.3)
      assertThat(match.result()).isEqualTo(MatchResult.DRAW)
      assertThat(match.tedHalftimeSpeech()).isEqualTo("Guys, I want you to know, I don't care if we win or lose today. I just want you to go out there and play the best football of your lives.")
      assertThat(match.ticketRevenueGbp()).isEqualTo("735000.00")
      assertThat(match.turningPoints()).containsExactly(TurningPoint.builder()
          .description("Jamie Tartt passes to Sam instead of shooting")
          .emotionalImpact("Showed Jamie's growth from selfish to team player")
          .minute(89L)
          .characterInvolved("jamie-tartt")
    ...
    fun roundtrip() {
      ...
      val roundtrippedMatch = jsonMapper.readValue(jsonMapper.writeValueAsString(match), jacksonTypeRef<Match>())
