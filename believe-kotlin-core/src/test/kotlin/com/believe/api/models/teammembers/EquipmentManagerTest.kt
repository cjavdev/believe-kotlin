...
internal class EquipmentManagerTest {
    ...
    fun create() {
      ...
      assertThat(equipmentManager.memberType()).isEqualTo(EquipmentManager.MemberType.EQUIPMENT_MANAGER)
      assertThat(equipmentManager.responsibilities()).containsExactly("Kit preparation", "Equipment maintenance")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedEquipmentManager = jsonMapper.readValue(jsonMapper.writeValueAsString(equipmentManager), jacksonTypeRef<EquipmentManager>())
