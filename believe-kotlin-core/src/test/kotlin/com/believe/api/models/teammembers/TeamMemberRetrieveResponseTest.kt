...
internal class TeamMemberRetrieveResponseTest {
    ...
    fun ofPlayerRoundtrip() {
      ...
      val teamMemberRetrieveResponse = TeamMemberRetrieveResponse.ofPlayer(Player.builder()
          .id("jamie-tartt-richmond")
          .characterId("jamie-tartt")
          .jerseyNumber(9L)
          .position(Position.FORWARD)
      ...
      val roundtrippedTeamMemberRetrieveResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(teamMemberRetrieveResponse), jacksonTypeRef<TeamMemberRetrieveResponse>())
    ...
    fun ofCoachRoundtrip() {
      val jsonMapper = jsonMapper()
      val teamMemberRetrieveResponse = TeamMemberRetrieveResponse.ofCoach(Coach.builder()
          .id("ted-lasso-richmond")
          .characterId("ted-lasso")
          .specialty(CoachSpecialty.HEAD_COACH)
          .teamId("afc-richmond")
    ...
    @Test
    fun ofMedicalStaff() {
      val medicalStaff = MedicalStaff.builder()
    ...
    fun ofMedicalStaffRoundtrip() {
      val jsonMapper = jsonMapper()
      val teamMemberRetrieveResponse = TeamMemberRetrieveResponse.ofMedicalStaff(MedicalStaff.builder()
          .id("sharon-fieldstone-richmond")
          .characterId("dr-sharon")
          .specialty(MedicalSpecialty.SPORTS_PSYCHOLOGIST)
          .teamId("afc-richmond")
    ...
    fun ofEquipmentManager() {
      val equipmentManager = EquipmentManager.builder()
      ...
      val teamMemberRetrieveResponse = TeamMemberRetrieveResponse.ofEquipmentManager(equipmentManager)
    ...
    fun ofEquipmentManagerRoundtrip() {
      val jsonMapper = jsonMapper()
      val teamMemberRetrieveResponse = TeamMemberRetrieveResponse.ofEquipmentManager(EquipmentManager.builder()
          .id("nate-kitman-richmond")
          .characterId("nathan-shelley")
          .teamId("afc-richmond")
          .yearsWithTeam(5L)
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
      val teamMemberRetrieveResponse = jsonMapper().convertValue(testCase.value, jacksonTypeRef<TeamMemberRetrieveResponse>())

      val e = assertThrows<BelieveInvalidDataException> {
        teamMemberRetrieveResponse.validate()
      }
