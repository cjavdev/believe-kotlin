...
internal class EmotionalStatsTest {
    ...
    @Test
    fun create() {
      val emotionalStats = EmotionalStats.builder()
          .curiosity(99L)
          .empathy(100L)
          .optimism(95L)
          .resilience(90L)
    ...
    fun roundtrip() {
      ...
      val roundtrippedEmotionalStats = jsonMapper.readValue(jsonMapper.writeValueAsString(emotionalStats), jacksonTypeRef<EmotionalStats>())
