...
internal class CharacterCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = CharacterCreateParams.builder()
          .background("Legendary midfielder for Chelsea and AFC Richmond, now assistant coach. Known for his gruff exterior hiding a heart of gold.")
          .emotionalStats(EmotionalStats.builder()
              .curiosity(40L)
              .empathy(85L)
      ...
      assertThat(body.background()).isEqualTo("Legendary midfielder for Chelsea and AFC Richmond, now assistant coach. Known for his gruff exterior hiding a heart of gold.")
      assertThat(body.emotionalStats()).isEqualTo(EmotionalStats.builder()
          .curiosity(40L)
          .empathy(85L)
          .optimism(45L)
          .resilience(95L)
      ...
      assertThat(body.personalityTraits()).containsExactly("intense", "loyal", "secretly caring", "profane")
      ...
      assertThat(body.growthArcs()).containsExactly(GrowthArc.builder()
          .breakthrough("Finding purpose beyond playing")
          .challenge("Accepting his body's limitations")
          .endingPoint("Retired but lost")
          .season(1L)
      ...
      assertThat(body.salaryGbp()).isEqualTo(CharacterCreateParams.SalaryGbp.ofString("175000.00"))
      assertThat(body.signatureQuotes()).containsExactly("He's here, he's there, he's every-f***ing-where, Roy Kent!", "Whistle!")
