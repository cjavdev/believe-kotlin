...
internal class CharacterListPageResponseTest {
    ...
    @Test
    fun create() {
      val characterListPageResponse = CharacterListPageResponse.builder()
          .addData(Character.builder()
              .id("ted-lasso")
      ...
      assertThat(characterListPageResponse.data()).containsExactly(Character.builder()
          .id("ted-lasso")
          .background("Former American football coach from Kansas who moved to London to coach AFC Richmond")
          .emotionalStats(EmotionalStats.builder()
              .curiosity(99L)
    ...
    fun roundtrip() {
      ...
      val roundtrippedCharacterListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(characterListPageResponse), jacksonTypeRef<CharacterListPageResponse>())
