...
internal class TicketSaleListPageResponseTest {
    ...
    @Test
    fun create() {
      val ticketSaleListPageResponse = TicketSaleListPageResponse.builder()
          .addData(TicketSale.builder()
              .id("ts-001")
              .buyerName("Mae Green")
              .currency("GBP")
              .discount("9.00")
      ...
      assertThat(ticketSaleListPageResponse.data()).containsExactly(TicketSale.builder()
          .id("ts-001")
          .buyerName("Mae Green")
          .currency("GBP")
          .discount("9.00")
    ...
    fun roundtrip() {
      ...
      val roundtrippedTicketSaleListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(ticketSaleListPageResponse), jacksonTypeRef<TicketSaleListPageResponse>())
