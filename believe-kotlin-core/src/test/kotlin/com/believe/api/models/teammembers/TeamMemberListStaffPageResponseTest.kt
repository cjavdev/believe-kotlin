...
internal class TeamMemberListStaffPageResponseTest {
    ...
    @Test
    fun create() {
      val teamMemberListStaffPageResponse = TeamMemberListStaffPageResponse.builder()
          .addData(MedicalStaff.builder()
      ...
      assertThat(teamMemberListStaffPageResponse.data()).containsExactly(TeamMemberListStaffResponse.ofMedicalStaff(MedicalStaff.builder()
          .id("sharon-fieldstone-richmond")
          .characterId("dr-sharon")
          .specialty(MedicalSpecialty.SPORTS_PSYCHOLOGIST)
          .teamId("afc-richmond")
    ...
    fun roundtrip() {
      ...
      val roundtrippedTeamMemberListStaffPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(teamMemberListStaffPageResponse), jacksonTypeRef<TeamMemberListStaffPageResponse>())

      assertThat(roundtrippedTeamMemberListStaffPageResponse).isEqualTo(teamMemberListStaffPageResponse)
    }
}
