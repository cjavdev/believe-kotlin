...
internal class CoachingPrincipleTest {
    ...
    @Test
    fun create() {
      val coachingPrinciple = CoachingPrinciple.builder()
          .id("be-curious")
      ...
      assertThat(coachingPrinciple.application()).isEqualTo("When someone frustrates you, ask questions before making assumptions. Seek to understand their perspective and motivations.")
      assertThat(coachingPrinciple.exampleFromShow()).isEqualTo("Ted uses this principle during the dart game with Rupert, explaining how people underestimated him his whole life because they judged before being curious.")
      assertThat(coachingPrinciple.explanation()).isEqualTo("Approach people and situations with genuine curiosity rather than preconceived judgments. Everyone has a story worth understanding.")
      assertThat(coachingPrinciple.principle()).isEqualTo("Be curious, not judgmental")
      assertThat(coachingPrinciple.tedQuote()).isEqualTo("Be curious, not judgmental. - Walt Whitman... I think.")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCoachingPrinciple = jsonMapper.readValue(jsonMapper.writeValueAsString(coachingPrinciple), jacksonTypeRef<CoachingPrinciple>())
