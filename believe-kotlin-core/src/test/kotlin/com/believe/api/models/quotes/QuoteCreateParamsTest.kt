...
internal class QuoteCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.context()).isEqualTo("Ted's first team meeting, revealing his coaching philosophy")
      ...
      assertThat(body.secondaryThemes()).containsExactly(QuoteTheme.LEADERSHIP, QuoteTheme.TEAMWORK)
