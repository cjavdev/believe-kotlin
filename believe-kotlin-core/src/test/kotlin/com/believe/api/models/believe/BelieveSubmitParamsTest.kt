...
internal class BelieveSubmitParamsTest {
    ...
    @Test
    fun body() {
      val params = BelieveSubmitParams.builder()
          .situation("I just got passed over for a promotion I've been working toward for two years.")
          .situationType(BelieveSubmitParams.SituationType.WORK_CHALLENGE)
          .context("I've always tried to be a team player and support my colleagues.")
          .intensity(7L)
      ...
      assertThat(body.situation()).isEqualTo("I just got passed over for a promotion I've been working toward for two years.")
      assertThat(body.situationType()).isEqualTo(BelieveSubmitParams.SituationType.WORK_CHALLENGE)
      assertThat(body.context()).isEqualTo("I've always tried to be a team player and support my colleagues.")
