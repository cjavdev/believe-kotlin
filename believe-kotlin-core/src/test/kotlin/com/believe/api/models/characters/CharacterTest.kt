...
internal class CharacterTest {
    ...
    fun create() {
      ...
      assertThat(character.background()).isEqualTo("Former American football coach from Kansas who moved to London to coach AFC Richmond")
      assertThat(character.emotionalStats()).isEqualTo(EmotionalStats.builder()
          .curiosity(99L)
          .empathy(100L)
          .optimism(95L)
          .resilience(90L)
      ...
      assertThat(character.personalityTraits()).containsExactly("optimistic", "kind", "folksy", "persistent")
      ...
      assertThat(character.growthArcs()).containsExactly(GrowthArc.builder()
          .breakthrough("Showing vulnerability about his marriage")
          .challenge("Earning respect despite inexperience")
          .endingPoint("Accepted by the team despite relegation")
          .season(1L)
      ...
      assertThat(character.profileImageUrl()).isEqualTo("https://afcrichmond.com/images/ted-lasso.jpg")
      assertThat(character.salaryGbp()).isEqualTo("150000.00")
      assertThat(character.signatureQuotes()).containsExactly("I believe in believe.", "Be curious, not judgmental.")
