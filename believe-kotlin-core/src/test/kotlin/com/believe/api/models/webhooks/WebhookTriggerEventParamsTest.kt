...
internal class WebhookTriggerEventParamsTest {
    ...
    @Test
    fun body() {
      val params = WebhookTriggerEventParams.builder()
          .eventType(WebhookTriggerEventParams.EventType.MATCH_COMPLETED)
          .matchCompletedPayload(WebhookTriggerEventParams.Payload.MatchCompleted.Data.builder()
              .awayScore(0L)
              .awayTeamId("away_team_id")
      ...
      assertThat(body.payload()).isEqualTo(WebhookTriggerEventParams.Payload.ofMatchCompleted(WebhookTriggerEventParams.Payload.MatchCompleted.builder()
          .data(WebhookTriggerEventParams.Payload.MatchCompleted.Data.builder()
              .awayScore(0L)
              .awayTeamId("away_team_id")
              .completedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .homeScore(0L)
