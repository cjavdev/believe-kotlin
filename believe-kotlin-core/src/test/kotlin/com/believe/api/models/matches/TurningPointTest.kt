...
internal class TurningPointTest {
    ...
    @Test
    fun create() {
      val turningPoint = TurningPoint.builder()
      ...
      assertThat(turningPoint.emotionalImpact()).isEqualTo("Galvanized the team's fighting spirit")
    ...
    fun roundtrip() {
      ...
      val roundtrippedTurningPoint = jsonMapper.readValue(jsonMapper.writeValueAsString(turningPoint), jacksonTypeRef<TurningPoint>())
