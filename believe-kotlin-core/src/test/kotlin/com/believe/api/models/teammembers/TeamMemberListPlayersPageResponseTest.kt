...
internal class TeamMemberListPlayersPageResponseTest {
    ...
    @Test
    fun create() {
      val teamMemberListPlayersPageResponse = TeamMemberListPlayersPageResponse.builder()
          .addData(Player.builder()
      ...
      assertThat(teamMemberListPlayersPageResponse.data()).containsExactly(Player.builder()
          .id("jamie-tartt-richmond")
          .characterId("jamie-tartt")
          .jerseyNumber(9L)
          .position(Position.FORWARD)
    ...
    fun roundtrip() {
      ...
      val roundtrippedTeamMemberListPlayersPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(teamMemberListPlayersPageResponse), jacksonTypeRef<TeamMemberListPlayersPageResponse>())

      assertThat(roundtrippedTeamMemberListPlayersPageResponse).isEqualTo(teamMemberListPlayersPageResponse)
    }
}
