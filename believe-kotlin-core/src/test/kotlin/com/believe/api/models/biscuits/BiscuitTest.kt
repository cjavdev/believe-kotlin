...
internal class BiscuitTest {
    ...
    fun create() {
      ...
      assertThat(biscuit.message()).isEqualTo("Sometimes the best thing you can do is just show up with something warm.")
      assertThat(biscuit.pairsWellWith()).isEqualTo("A hot cup of tea and an honest conversation")
      assertThat(biscuit.tedNote()).isEqualTo("Made these thinking about you. Hope your day is as sweet as these little fellas. - Ted")
    ...
    fun roundtrip() {
      ...
      val roundtrippedBiscuit = jsonMapper.readValue(jsonMapper.writeValueAsString(biscuit), jacksonTypeRef<Biscuit>())
