...
internal class TeamCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = TeamCreateParams.builder()
          .cultureScore(70L)
          .foundedYear(1895L)
          .league(League.PREMIER_LEAGUE)
          .name("West Ham United")
      ...
      assertThat(body.values()).isEqualTo(TeamValues.builder()
          .primaryValue("Pride")
          .secondaryValues(listOf(
            "History",
            "Community",
          ...
          .teamMotto("Forever Blowing Bubbles")
          .build())
      assertThat(body.annualBudgetGbp()).isEqualTo(TeamCreateParams.AnnualBudgetGbp.ofString("150000000.00"))
      ...
      assertThat(body.stadiumLocation()).isEqualTo(GeoLocation.builder()
          .latitude(51.5387)
          .longitude(-0.0166)
          .build())
