...
internal class TeamMemberCreateParamsTest {
    ...
    fun create() {
      TeamMemberCreateParams.builder()
          .member(TeamMemberCreateParams.Member.Player.builder()
    ...
    @Test
    fun body() {
      val params = TeamMemberCreateParams.builder()
          .member(TeamMemberCreateParams.Member.Player.builder()
              .characterId("jamie-tartt")
              .jerseyNumber(9L)
              .position(Position.FORWARD)
      ...
      assertThat(body).isEqualTo(TeamMemberCreateParams.Member.ofPlayer(TeamMemberCreateParams.Member.Player.builder()
          .characterId("jamie-tartt")
          .jerseyNumber(9L)
          .position(Position.FORWARD)
          .teamId("afc-richmond")
