...
internal class PepTalkRetrieveResponseTest {
    ...
    @Test
    fun create() {
      val pepTalkRetrieveResponse = PepTalkRetrieveResponse.builder()
          .chunks(listOf(
      ...
      assertThat(pepTalkRetrieveResponse.chunks()).containsExactly(PepTalkRetrieveResponse.Chunk.builder()
          .chunkId(1L)
          .isFinal(false)
          .text("Hey there, friend. ")
          .emotionalBeat("connection")
          .build(), PepTalkRetrieveResponse.Chunk.builder()
          .chunkId(2L)
          .isFinal(false)
          .text("I know things feel tough right now. ")
          .emotionalBeat("acknowledgment")
          ...
          .emotionalBeat("encouragement")
          .build())
      assertThat(pepTalkRetrieveResponse.text()).isEqualTo("Hey there, friend. I know things feel tough right now. And that's the thing about hard times - they're like a good barbecue rub. They might sting at first, but they're what give you flavor. You got this.")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedPepTalkRetrieveResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(pepTalkRetrieveResponse), jacksonTypeRef<PepTalkRetrieveResponse>())
