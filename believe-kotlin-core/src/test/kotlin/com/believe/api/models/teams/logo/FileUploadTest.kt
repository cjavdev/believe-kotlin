...
internal class FileUploadTest {
    ...
    @Test
    fun create() {
      val fileUpload = FileUpload.builder()
      ...
      assertThat(fileUpload.uploadedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedFileUpload = jsonMapper.readValue(jsonMapper.writeValueAsString(fileUpload), jacksonTypeRef<FileUpload>())
