...
internal class MatchListPageResponseTest {
    ...
    @Test
    fun create() {
      val matchListPageResponse = MatchListPageResponse.builder()
          .addData(Match.builder()
              .id("match-001")
      ...
      assertThat(matchListPageResponse.data()).containsExactly(Match.builder()
          .id("match-001")
          .awayTeamId("manchester-city")
          .date(OffsetDateTime.parse("2024-01-15T15:00:00Z"))
          .homeTeamId("afc-richmond")
    ...
    fun roundtrip() {
      ...
      val roundtrippedMatchListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(matchListPageResponse), jacksonTypeRef<MatchListPageResponse>())
