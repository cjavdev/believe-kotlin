...
internal class RegisteredWebhookTest {
    ...
    @Test
    fun create() {
      val registeredWebhook = RegisteredWebhook.builder()
          .id("wh_abc123")
      ...
      assertThat(registeredWebhook.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(registeredWebhook.eventTypes()).containsExactly(RegisteredWebhook.EventType.MATCH_COMPLETED)
    ...
    fun roundtrip() {
      ...
      val roundtrippedRegisteredWebhook = jsonMapper.readValue(jsonMapper.writeValueAsString(registeredWebhook), jacksonTypeRef<RegisteredWebhook>())
