...
internal class EpisodeCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = EpisodeCreateParams.builder()
          .airDate(LocalDate.parse("2020-10-02"))
          .characterFocus(listOf(
            "ted-lasso",
            "coach-beard",
      ...
      assertThat(body.characterFocus()).containsExactly("ted-lasso", "coach-beard", "higgins", "nate")
      ...
      assertThat(body.synopsis()).isEqualTo("Ted creates a support group for the coaching staff while Rebecca faces a difficult decision about her future.")
      assertThat(body.tedWisdom()).isEqualTo("There's two buttons I never like to hit: that's panic and snooze.")
      assertThat(body.title()).isEqualTo("The Diamond Dogs")
      assertThat(body.writer()).isEqualTo("Jason Sudeikis, Brendan Hunt, Joe Kelly")
      assertThat(body.biscuitsWithBossMoment()).isEqualTo("Ted and Rebecca have an honest conversation about trust.")
      assertThat(body.memorableMoments()).containsExactly("First Diamond Dogs meeting", "The famous dart scene with Rupert", "Be curious, not judgmental speech")
