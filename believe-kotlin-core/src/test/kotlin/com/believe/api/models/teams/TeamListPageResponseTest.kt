...
internal class TeamListPageResponseTest {
    ...
    @Test
    fun create() {
      val teamListPageResponse = TeamListPageResponse.builder()
          .addData(Team.builder()
              .id("afc-richmond")
              .cultureScore(85L)
              .foundedYear(1897L)
              ...
              .stadiumLocation(GeoLocation.builder()
                  .latitude(51.4816)
                  .longitude(-0.191)
                  .build())
      ...
      assertThat(teamListPageResponse.data()).containsExactly(Team.builder()
          .id("afc-richmond")
          .cultureScore(85L)
          .foundedYear(1897L)
          .league(League.PREMIER_LEAGUE)
    ...
    fun roundtrip() {
      ...
      val roundtrippedTeamListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(teamListPageResponse), jacksonTypeRef<TeamListPageResponse>())
