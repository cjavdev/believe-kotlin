...
internal class MatchCreateParamsTest {
    ...
    fun create() {
      MatchCreateParams.builder()
          ...
          .addTurningPoint(TurningPoint.builder()
    ...
    @Test
    fun body() {
      val params = MatchCreateParams.builder()
          .awayTeamId("tottenham")
          .date(OffsetDateTime.parse("2024-02-20T19:45:00Z"))
          .homeTeamId("afc-richmond")
          .matchType(MatchType.CUP)
      ...
      assertThat(body.lessonLearned()).isEqualTo("It's not about the wins and losses, it's about helping these young fellas be the best versions of themselves.")
      assertThat(body.possessionPercentage()).isEqualTo(50.0)
      assertThat(body.result()).isEqualTo(MatchResult.PENDING)
      assertThat(body.tedHalftimeSpeech()).isEqualTo("You know what the happiest animal on Earth is? It's a goldfish. You know why? It's got a 10-second memory.")
      assertThat(body.ticketRevenueGbp()).isEqualTo(MatchCreateParams.TicketRevenueGbp.ofString("735000.00"))
      assertThat(body.turningPoints()).containsExactly(TurningPoint.builder()
          .description("description")
          .emotionalImpact("Galvanized the team's fighting spirit")
          .minute(0L)
          .characterInvolved("jamie-tartt")
