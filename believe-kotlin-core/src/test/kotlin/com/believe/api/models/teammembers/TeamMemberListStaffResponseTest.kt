...
internal class TeamMemberListStaffResponseTest {
    ...
    fun ofMedicalStaffRoundtrip() {
      ...
      val teamMemberListStaffResponse = TeamMemberListStaffResponse.ofMedicalStaff(MedicalStaff.builder()
          .id("sharon-fieldstone-richmond")
          .characterId("dr-sharon")
          .specialty(MedicalSpecialty.SPORTS_PSYCHOLOGIST)
          .teamId("afc-richmond")
      ...
      val roundtrippedTeamMemberListStaffResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(teamMemberListStaffResponse), jacksonTypeRef<TeamMemberListStaffResponse>())
    ...
    fun ofEquipmentManager() {
      ...
      val teamMemberListStaffResponse = TeamMemberListStaffResponse.ofEquipmentManager(equipmentManager)
    ...
    fun ofEquipmentManagerRoundtrip() {
      val jsonMapper = jsonMapper()
      val teamMemberListStaffResponse = TeamMemberListStaffResponse.ofEquipmentManager(EquipmentManager.builder()
          .id("nate-kitman-richmond")
          .characterId("nathan-shelley")
          .teamId("afc-richmond")
          .yearsWithTeam(5L)
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
      val teamMemberListStaffResponse = jsonMapper().convertValue(testCase.value, jacksonTypeRef<TeamMemberListStaffResponse>())

      val e = assertThrows<BelieveInvalidDataException> {
        teamMemberListStaffResponse.validate()
      }
