...
internal class PaginatedResponseTest {
    ...
    @Test
    fun create() {
      val paginatedResponse = PaginatedResponse.builder()
          .addData(Episode.builder()
              .id("s01e01")
      ...
      assertThat(paginatedResponse.data()).containsExactly(Episode.builder()
          .id("s01e01")
          .airDate(LocalDate.parse("2020-08-14"))
          .characterFocus(listOf(
            "ted-lasso",
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaginatedResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(paginatedResponse), jacksonTypeRef<PaginatedResponse>())
