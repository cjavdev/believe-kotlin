...
internal class WebhookDeleteResponseTest {
    ...
    @Test
    fun create() {
      val webhookDeleteResponse = WebhookDeleteResponse.builder()
    ...
    fun roundtrip() {
      ...
      val roundtrippedWebhookDeleteResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(webhookDeleteResponse), jacksonTypeRef<WebhookDeleteResponse>())
