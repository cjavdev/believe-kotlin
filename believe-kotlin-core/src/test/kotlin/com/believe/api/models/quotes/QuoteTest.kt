...
internal class QuoteTest {
    ...
    fun create() {
      ...
      assertThat(quote.context()).isEqualTo("Ted playing darts against Rupert in the pub, explaining his philosophy")
    ...
    fun roundtrip() {
      ...
      val roundtrippedQuote = jsonMapper.readValue(jsonMapper.writeValueAsString(quote), jacksonTypeRef<Quote>())
