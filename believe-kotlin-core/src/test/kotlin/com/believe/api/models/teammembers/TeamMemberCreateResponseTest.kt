...
internal class TeamMemberCreateResponseTest {
    ...
    fun ofCoachRoundtrip() {
      val jsonMapper = jsonMapper()
      val teamMemberCreateResponse = TeamMemberCreateResponse.ofCoach(Coach.builder()
          .id("ted-lasso-richmond")
          .characterId("ted-lasso")
          .specialty(CoachSpecialty.HEAD_COACH)
          .teamId("afc-richmond")
    ...
    fun ofMedicalStaffRoundtrip() {
      val jsonMapper = jsonMapper()
      val teamMemberCreateResponse = TeamMemberCreateResponse.ofMedicalStaff(MedicalStaff.builder()
          .id("sharon-fieldstone-richmond")
          .characterId("dr-sharon")
          .specialty(MedicalSpecialty.SPORTS_PSYCHOLOGIST)
          .teamId("afc-richmond")
    ...
    fun ofEquipmentManagerRoundtrip() {
      val jsonMapper = jsonMapper()
      val teamMemberCreateResponse = TeamMemberCreateResponse.ofEquipmentManager(EquipmentManager.builder()
          .id("nate-kitman-richmond")
          .characterId("nathan-shelley")
          .teamId("afc-richmond")
          .yearsWithTeam(5L)
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
      val teamMemberCreateResponse = jsonMapper().convertValue(testCase.value, jacksonTypeRef<TeamMemberCreateResponse>())

      val e = assertThrows<BelieveInvalidDataException> {
        teamMemberCreateResponse.validate()
      }
