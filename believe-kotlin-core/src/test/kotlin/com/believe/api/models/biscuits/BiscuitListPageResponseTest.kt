...
internal class BiscuitListPageResponseTest {
    ...
    @Test
    fun create() {
      val biscuitListPageResponse = BiscuitListPageResponse.builder()
          .addData(Biscuit.builder()
              .id("biscuit-001")
      ...
      assertThat(biscuitListPageResponse.data()).containsExactly(Biscuit.builder()
          .id("biscuit-001")
          .message("Sometimes the best thing you can do is just show up with something warm.")
          .pairsWellWith("A hot cup of tea and an honest conversation")
          .tedNote("Made these thinking about you. Hope your day is as sweet as these little fellas. - Ted")
    ...
    fun roundtrip() {
      ...
      val roundtrippedBiscuitListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(biscuitListPageResponse), jacksonTypeRef<BiscuitListPageResponse>())
