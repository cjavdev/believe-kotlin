...
internal class TeamTest {
    ...
    fun create() {
      ...
      assertThat(team.values()).isEqualTo(TeamValues.builder()
          .primaryValue("Believe")
          .secondaryValues(listOf(
            "Family",
            "Resilience",
      ...
      assertThat(team.stadiumLocation()).isEqualTo(GeoLocation.builder()
          .latitude(51.4816)
          .longitude(-0.191)
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedTeam = jsonMapper.readValue(jsonMapper.writeValueAsString(team), jacksonTypeRef<Team>())
