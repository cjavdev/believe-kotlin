...
class TicketSaleServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : TicketSaleService {

    private val withRawResponse: TicketSaleService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): TicketSaleService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TicketSaleService = TicketSaleServiceImpl(clientOptions.toBuilder().apply(modifier).build())

    override fun create(params: TicketSaleCreateParams, requestOptions: RequestOptions): TicketSale =
        // post /ticket-sales
        withRawResponse().create(params, requestOptions).parse()

    override fun retrieve(params: TicketSaleRetrieveParams, requestOptions: RequestOptions): TicketSale =
        // get /ticket-sales/{ticket_sale_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun update(params: TicketSaleUpdateParams, requestOptions: RequestOptions): TicketSale =
        // patch /ticket-sales/{ticket_sale_id}
        withRawResponse().update(params, requestOptions).parse()

    override fun list(params: TicketSaleListParams, requestOptions: RequestOptions): TicketSaleListPage =
        // get /ticket-sales
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TicketSaleService.WithRawResponse = TicketSaleServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<TicketSale> = jsonHandler<TicketSale>(clientOptions.jsonMapper)

        override fun create(params: TicketSaleCreateParams, requestOptions: RequestOptions): HttpResponseFor<TicketSale> {
        ...
        override fun retrieve(params: TicketSaleRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<TicketSale> {
        ...
        override fun update(params: TicketSaleUpdateParams, requestOptions: RequestOptions): HttpResponseFor<TicketSale> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("ticketSaleId", params.ticketSaleId())
          val request = HttpRequest.builder()
        ...
        override fun list(params: TicketSaleListParams, requestOptions: RequestOptions): HttpResponseFor<TicketSaleListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("ticket-sales")
        ...
        override fun delete(params: TicketSaleDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("ticketSaleId", params.ticketSaleId())
          val request = HttpRequest.builder()
