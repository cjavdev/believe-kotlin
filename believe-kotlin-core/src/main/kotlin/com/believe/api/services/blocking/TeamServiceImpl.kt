...
class TeamServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : TeamService {

    private val withRawResponse: TeamService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TeamService = TeamServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override fun getCulture(params: TeamGetCultureParams, requestOptions: RequestOptions): TeamGetCultureResponse =
        // get /teams/{team_id}/culture
        withRawResponse().getCulture(params, requestOptions).parse()

    override fun getRivals(params: TeamGetRivalsParams, requestOptions: RequestOptions): List<Team> =
        // get /teams/{team_id}/rivals
        withRawResponse().getRivals(params, requestOptions).parse()

    override fun listLogos(params: TeamListLogosParams, requestOptions: RequestOptions): List<FileUpload> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val logo: LogoService.WithRawResponse by lazy { LogoServiceImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TeamService.WithRawResponse = TeamServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
        ...
        override fun create(params: TeamCreateParams, requestOptions: RequestOptions): HttpResponseFor<Team> {
        ...
        override fun retrieve(params: TeamRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Team> {
        ...
        override fun update(params: TeamUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Team> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("teamId", params.teamId())
          val request = HttpRequest.builder()
        ...
        override fun list(params: TeamListParams, requestOptions: RequestOptions): HttpResponseFor<TeamListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("teams")
        ...
        override fun delete(params: TeamDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("teamId", params.teamId())
          val request = HttpRequest.builder()
        ...
        override fun getCulture(params: TeamGetCultureParams, requestOptions: RequestOptions): HttpResponseFor<TeamGetCultureResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("teamId", params.teamId())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun getRivals(params: TeamGetRivalsParams, requestOptions: RequestOptions): HttpResponseFor<List<Team>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("teamId", params.teamId())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun listLogos(params: TeamListLogosParams, requestOptions: RequestOptions): HttpResponseFor<List<FileUpload>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("teamId", params.teamId())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
