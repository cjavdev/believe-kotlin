...
class MatchServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : MatchService {

    private val withRawResponse: MatchService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): MatchService = MatchServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override fun getLesson(params: MatchGetLessonParams, requestOptions: RequestOptions): MatchGetLessonResponse =
        // get /matches/{match_id}/lesson
        withRawResponse().getLesson(params, requestOptions).parse()

    override fun getTurningPoints(params: MatchGetTurningPointsParams, requestOptions: RequestOptions): List<MatchGetTurningPointsResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val commentary: CommentaryService.WithRawResponse by lazy { CommentaryServiceImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): MatchService.WithRawResponse = MatchServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
        ...
        override fun create(params: MatchCreateParams, requestOptions: RequestOptions): HttpResponseFor<Match> {
        ...
        override fun retrieve(params: MatchRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Match> {
        ...
        override fun update(params: MatchUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Match> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("matchId", params.matchId())
          val request = HttpRequest.builder()
        ...
        override fun list(params: MatchListParams, requestOptions: RequestOptions): HttpResponseFor<MatchListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("matches")
        ...
        override fun delete(params: MatchDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("matchId", params.matchId())
          val request = HttpRequest.builder()
        ...
        override fun getLesson(params: MatchGetLessonParams, requestOptions: RequestOptions): HttpResponseFor<MatchGetLessonResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("matchId", params.matchId())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun getTurningPoints(params: MatchGetTurningPointsParams, requestOptions: RequestOptions): HttpResponseFor<List<MatchGetTurningPointsResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("matchId", params.matchId())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun streamLive(params: MatchStreamLiveParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
