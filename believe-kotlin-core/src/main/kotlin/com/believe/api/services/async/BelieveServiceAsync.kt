...
interface BelieveServiceAsync {
    ...
    suspend fun submit(params: BelieveSubmitParams, requestOptions: RequestOptions = RequestOptions.none()): BelieveSubmitResponse
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): BelieveServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /believe`, but is otherwise the             same as [BelieveServiceAsync.submit]. */
        @MustBeClosed
        suspend fun submit(params: BelieveSubmitParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<BelieveSubmitResponse>
    }
}
