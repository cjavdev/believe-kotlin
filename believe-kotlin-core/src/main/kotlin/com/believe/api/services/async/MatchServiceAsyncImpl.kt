...
class MatchServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : MatchServiceAsync {

    private val withRawResponse: MatchServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val commentary: CommentaryServiceAsync by lazy { CommentaryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): MatchServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): MatchServiceAsync = MatchServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override suspend fun retrieve(params: MatchRetrieveParams, requestOptions: RequestOptions): Match =
    ...
    override suspend fun list(params: MatchListParams, requestOptions: RequestOptions): MatchListPageAsync =
        // get /matches
    ...
    override suspend fun getLesson(params: MatchGetLessonParams, requestOptions: RequestOptions): MatchGetLessonResponse =
        // get /matches/{match_id}/lesson
        withRawResponse().getLesson(params, requestOptions).parse()

    override suspend fun getTurningPoints(params: MatchGetTurningPointsParams, requestOptions: RequestOptions): List<MatchGetTurningPointsResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val commentary: CommentaryServiceAsync.WithRawResponse by lazy { CommentaryServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): MatchServiceAsync.WithRawResponse = MatchServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
        ...
        override suspend fun create(params: MatchCreateParams, requestOptions: RequestOptions): HttpResponseFor<Match> {
        ...
        override suspend fun retrieve(params: MatchRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Match> {
        ...
        override suspend fun update(params: MatchUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Match> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("matchId", params.matchId())
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<MatchListPageResponse> = jsonHandler<MatchListPageResponse>(clientOptions.jsonMapper)

        override suspend fun list(params: MatchListParams, requestOptions: RequestOptions): HttpResponseFor<MatchListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("matches")
        ...
        override suspend fun delete(params: MatchDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("matchId", params.matchId())
          val request = HttpRequest.builder()
        ...
        private val getLessonHandler: Handler<MatchGetLessonResponse> = jsonHandler<MatchGetLessonResponse>(clientOptions.jsonMapper)

        override suspend fun getLesson(params: MatchGetLessonParams, requestOptions: RequestOptions): HttpResponseFor<MatchGetLessonResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("matchId", params.matchId())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        private val getTurningPointsHandler: Handler<List<MatchGetTurningPointsResponse>> = jsonHandler<List<MatchGetTurningPointsResponse>>(clientOptions.jsonMapper)

        override suspend fun getTurningPoints(params: MatchGetTurningPointsParams, requestOptions: RequestOptions): HttpResponseFor<List<MatchGetTurningPointsResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("matchId", params.matchId())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return errorHandler.handle(response).parseable {
              response.use {
                  getTurningPointsHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
        ...
        override suspend fun streamLive(params: MatchStreamLiveParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
