...
class EpisodeServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : EpisodeService {

    private val withRawResponse: EpisodeService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): EpisodeService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): EpisodeService = EpisodeServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override fun getWisdom(params: EpisodeGetWisdomParams, requestOptions: RequestOptions): EpisodeGetWisdomResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): EpisodeService.WithRawResponse = EpisodeServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<Episode> = jsonHandler<Episode>(clientOptions.jsonMapper)

        override fun create(params: EpisodeCreateParams, requestOptions: RequestOptions): HttpResponseFor<Episode> {
        ...
        override fun retrieve(params: EpisodeRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Episode> {
        ...
        override fun update(params: EpisodeUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Episode> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("episodeId", params.episodeId())
          val request = HttpRequest.builder()
        ...
        override fun list(params: EpisodeListParams, requestOptions: RequestOptions): HttpResponseFor<EpisodeListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("episodes")
        ...
        override fun delete(params: EpisodeDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("episodeId", params.episodeId())
          val request = HttpRequest.builder()
        ...
        override fun getWisdom(params: EpisodeGetWisdomParams, requestOptions: RequestOptions): HttpResponseFor<EpisodeGetWisdomResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("episodeId", params.episodeId())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
