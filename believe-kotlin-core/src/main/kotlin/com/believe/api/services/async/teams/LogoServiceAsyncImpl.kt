...
class LogoServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : LogoServiceAsync {

    private val withRawResponse: LogoServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): LogoServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): LogoServiceAsync = LogoServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override suspend fun download(params: LogoDownloadParams, requestOptions: RequestOptions): LogoDownloadResponse =
        // get /teams/{team_id}/logo/{file_id}
        withRawResponse().download(params, requestOptions).parse()

    override suspend fun upload(params: LogoUploadParams, requestOptions: RequestOptions): FileUpload =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): LogoServiceAsync.WithRawResponse = LogoServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val deleteHandler: Handler<Void?> = emptyHandler()

        override suspend fun delete(params: LogoDeleteParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override suspend fun download(params: LogoDownloadParams, requestOptions: RequestOptions): HttpResponseFor<LogoDownloadResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("fileId", params.fileId())
          val request = HttpRequest.builder()
        ...
        override suspend fun upload(params: LogoUploadParams, requestOptions: RequestOptions): HttpResponseFor<FileUpload> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
