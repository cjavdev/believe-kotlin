...
class QuoteServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : QuoteService {

    private val withRawResponse: QuoteService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): QuoteService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): QuoteService = QuoteServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override fun listByCharacter(params: QuoteListByCharacterParams, requestOptions: RequestOptions): QuoteListByCharacterPage =
        // get /quotes/characters/{character_id}
        withRawResponse().listByCharacter(params, requestOptions).parse()

    override fun listByTheme(params: QuoteListByThemeParams, requestOptions: RequestOptions): QuoteListByThemePage =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): QuoteService.WithRawResponse = QuoteServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<Quote> = jsonHandler<Quote>(clientOptions.jsonMapper)

        override fun create(params: QuoteCreateParams, requestOptions: RequestOptions): HttpResponseFor<Quote> {
        ...
        override fun retrieve(params: QuoteRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Quote> {
        ...
        override fun update(params: QuoteUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Quote> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("quoteId", params.quoteId())
          val request = HttpRequest.builder()
        ...
        override fun list(params: QuoteListParams, requestOptions: RequestOptions): HttpResponseFor<QuoteListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("quotes")
        ...
        override fun delete(params: QuoteDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("quoteId", params.quoteId())
          val request = HttpRequest.builder()
        ...
        override fun getRandom(params: QuoteGetRandomParams, requestOptions: RequestOptions): HttpResponseFor<Quote> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun listByCharacter(params: QuoteListByCharacterParams, requestOptions: RequestOptions): HttpResponseFor<QuoteListByCharacterPage> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun listByTheme(params: QuoteListByThemeParams, requestOptions: RequestOptions): HttpResponseFor<QuoteListByThemePage> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
