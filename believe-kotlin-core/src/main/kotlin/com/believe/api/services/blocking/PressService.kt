...
interface PressService {
    ...
    fun simulate(params: PressSimulateParams, requestOptions: RequestOptions = RequestOptions.none()): PressSimulateResponse
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /press`, but is otherwise the             same as [PressService.simulate]. */
        @MustBeClosed
        fun simulate(params: PressSimulateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PressSimulateResponse>
    }
}
