...
interface HealthServiceAsync {
    ...
    suspend fun check(params: HealthCheckParams = HealthCheckParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HealthCheckResponse
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): HealthServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `get /health`, but is otherwise the             same as [HealthServiceAsync.check]. */
        @MustBeClosed
        suspend fun check(params: HealthCheckParams = HealthCheckParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<HealthCheckResponse>
