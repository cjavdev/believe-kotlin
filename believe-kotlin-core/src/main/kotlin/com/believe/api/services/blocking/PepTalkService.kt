...
interface PepTalkService {
    ...
    fun retrieve(params: PepTalkRetrieveParams = PepTalkRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): PepTalkRetrieveResponse
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /pep-talk`, but is otherwise the             same as [PepTalkService.retrieve]. */
        @MustBeClosed
        fun retrieve(params: PepTalkRetrieveParams = PepTalkRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PepTalkRetrieveResponse>
