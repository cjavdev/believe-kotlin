...
class WServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : WServiceAsync {

    private val withRawResponse: WServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): WServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): WServiceAsync = WServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): WServiceAsync.WithRawResponse = WServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val testHandler: Handler<Void?> = emptyHandler()

        override suspend fun test(params: WTestParams, requestOptions: RequestOptions): HttpResponse {
