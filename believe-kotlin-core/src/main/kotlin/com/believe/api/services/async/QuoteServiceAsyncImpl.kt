...
class QuoteServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : QuoteServiceAsync {

    private val withRawResponse: QuoteServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): QuoteServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): QuoteServiceAsync = QuoteServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override suspend fun create(params: QuoteCreateParams, requestOptions: RequestOptions): Quote =
        // post /quotes
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun retrieve(params: QuoteRetrieveParams, requestOptions: RequestOptions): Quote =
        // get /quotes/{quote_id}
    ...
    override suspend fun list(params: QuoteListParams, requestOptions: RequestOptions): QuoteListPageAsync =
        // get /quotes
    ...
    override suspend fun getRandom(params: QuoteGetRandomParams, requestOptions: RequestOptions): Quote =
        // get /quotes/random
        withRawResponse().getRandom(params, requestOptions).parse()

    override suspend fun listByCharacter(params: QuoteListByCharacterParams, requestOptions: RequestOptions): QuoteListByCharacterPageAsync =
        // get /quotes/characters/{character_id}
        withRawResponse().listByCharacter(params, requestOptions).parse()

    override suspend fun listByTheme(params: QuoteListByThemeParams, requestOptions: RequestOptions): QuoteListByThemePageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): QuoteServiceAsync.WithRawResponse = QuoteServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<Quote> = jsonHandler<Quote>(clientOptions.jsonMapper)

        override suspend fun create(params: QuoteCreateParams, requestOptions: RequestOptions): HttpResponseFor<Quote> {
        ...
        override suspend fun retrieve(params: QuoteRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Quote> {
        ...
        override suspend fun update(params: QuoteUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Quote> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("quoteId", params.quoteId())
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<PaginatedResponseQuote> = jsonHandler<PaginatedResponseQuote>(clientOptions.jsonMapper)

        override suspend fun list(params: QuoteListParams, requestOptions: RequestOptions): HttpResponseFor<QuoteListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("quotes")
        ...
        override suspend fun delete(params: QuoteDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("quoteId", params.quoteId())
          val request = HttpRequest.builder()
        ...
        override suspend fun getRandom(params: QuoteGetRandomParams, requestOptions: RequestOptions): HttpResponseFor<Quote> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        private val listByCharacterHandler: Handler<PaginatedResponseQuote> = jsonHandler<PaginatedResponseQuote>(clientOptions.jsonMapper)

        override suspend fun listByCharacter(params: QuoteListByCharacterParams, requestOptions: RequestOptions): HttpResponseFor<QuoteListByCharacterPageAsync> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          ...
          return errorHandler.handle(response).parseable {
              response.use {
                  listByCharacterHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
        ...
        private val listByThemeHandler: Handler<PaginatedResponseQuote> = jsonHandler<PaginatedResponseQuote>(clientOptions.jsonMapper)

        override suspend fun listByTheme(params: QuoteListByThemeParams, requestOptions: RequestOptions): HttpResponseFor<QuoteListByThemePageAsync> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
