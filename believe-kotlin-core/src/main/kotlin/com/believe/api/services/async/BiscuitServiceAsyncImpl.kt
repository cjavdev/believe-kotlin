...
class BiscuitServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BiscuitServiceAsync {

    private val withRawResponse: BiscuitServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): BiscuitServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): BiscuitServiceAsync = BiscuitServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override suspend fun retrieve(params: BiscuitRetrieveParams, requestOptions: RequestOptions): Biscuit =
        // get /biscuits/{biscuit_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun list(params: BiscuitListParams, requestOptions: RequestOptions): BiscuitListPageAsync =
        // get /biscuits
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun getFresh(params: BiscuitGetFreshParams, requestOptions: RequestOptions): Biscuit =
        // get /biscuits/fresh
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): BiscuitServiceAsync.WithRawResponse = BiscuitServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val retrieveHandler: Handler<Biscuit> = jsonHandler<Biscuit>(clientOptions.jsonMapper)

        override suspend fun retrieve(params: BiscuitRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Biscuit> {
        ...
        override suspend fun list(params: BiscuitListParams, requestOptions: RequestOptions): HttpResponseFor<BiscuitListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override suspend fun getFresh(params: BiscuitGetFreshParams, requestOptions: RequestOptions): HttpResponseFor<Biscuit> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
