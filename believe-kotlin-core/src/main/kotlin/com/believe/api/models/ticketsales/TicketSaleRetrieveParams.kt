...
class TicketSaleRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ticketSaleRetrieveParams: TicketSaleRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TicketSaleRetrieveParams && ticketSaleId == other.ticketSaleId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(ticketSaleId, additionalHeaders, additionalQueryParams)

    override fun toString() = "TicketSaleRetrieveParams{ticketSaleId=$ticketSaleId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
