...
class WebhookListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookListParams: WebhookListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is WebhookListParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(additionalHeaders, additionalQueryParams)

    override fun toString() = "WebhookListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
