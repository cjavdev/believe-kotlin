...
class QuoteRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(quoteRetrieveParams: QuoteRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is QuoteRetrieveParams && quoteId == other.quoteId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(quoteId, additionalHeaders, additionalQueryParams)

    override fun toString() = "QuoteRetrieveParams{quoteId=$quoteId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
