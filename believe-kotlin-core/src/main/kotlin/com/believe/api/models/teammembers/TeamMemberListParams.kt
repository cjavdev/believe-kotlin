 ...
 */
class TeamMemberListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(teamMemberListParams: TeamMemberListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamMemberListParams && limit == other.limit && memberType == other.memberType && skip == other.skip && teamId == other.teamId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(limit, memberType, skip, teamId, additionalHeaders, additionalQueryParams)

    override fun toString() = "TeamMemberListParams{limit=$limit, memberType=$memberType, skip=$skip, teamId=$teamId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
