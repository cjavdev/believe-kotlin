...
class TeamMemberRetrieveResponse private constructor(
    ...
    fun validate(): TeamMemberRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamMemberRetrieveResponse && player == other.player && coach == other.coach && medicalStaff == other.medicalStaff && equipmentManager == other.equipmentManager
    }
    ...
    override fun toString(): String =
        when {
            ...
            equipmentManager != null -> "TeamMemberRetrieveResponse{equipmentManager=$equipmentManager}"
    ...
    companion object {
        ...
        /** Full medical staff model with ID. */
        fun ofMedicalStaff(medicalStaff: MedicalStaff) = TeamMemberRetrieveResponse(medicalStaff = medicalStaff)

        /** Full equipment manager model with ID. */
        fun ofEquipmentManager(equipmentManager: EquipmentManager) = TeamMemberRetrieveResponse(equipmentManager = equipmentManager)
    }

    /** An interface that defines how to map each variant of [TeamMemberRetrieveResponse] to a value of type [T]. */
    interface Visitor<out T> {
         ...
         *
         * An instance of [TeamMemberRetrieveResponse] can contain an unknown variant if it was deserialized from data
    ...
    internal class Deserializer : BaseDeserializer<TeamMemberRetrieveResponse>(TeamMemberRetrieveResponse::class) {
    ...
    internal class Serializer : BaseSerializer<TeamMemberRetrieveResponse>(TeamMemberRetrieveResponse::class) {

        override fun serialize(value: TeamMemberRetrieveResponse, generator: JsonGenerator, provider: SerializerProvider) {
          when {
