...
class TeamMemberUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(teamMemberUpdateParams: TeamMemberUpdateParams) =
            apply {
        ...
        fun updates(playerUpdate: Updates.PlayerUpdate) = updates(Updates.ofPlayerUpdate(playerUpdate))
        ...
        fun updates(medicalStaffUpdate: Updates.MedicalStaffUpdate) = updates(Updates.ofMedicalStaffUpdate(medicalStaffUpdate))

        /** Alias for calling [updates] with `Updates.ofEquipmentManagerUpdate(equipmentManagerUpdate)`. */
        fun updates(equipmentManagerUpdate: Updates.EquipmentManagerUpdate) = updates(Updates.ofEquipmentManagerUpdate(equipmentManagerUpdate))
    ...
    class Updates private constructor(
        ...
        /** Update model for medical staff. */
        fun asMedicalStaffUpdate(): MedicalStaffUpdate = medicalStaffUpdate.getOrThrow("medicalStaffUpdate")

        /** Update model for equipment managers. */
        fun asEquipmentManagerUpdate(): EquipmentManagerUpdate = equipmentManagerUpdate.getOrThrow("equipmentManagerUpdate")
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                equipmentManagerUpdate != null -> visitor.visitEquipmentManagerUpdate(equipmentManagerUpdate)
                else -> visitor.unknown(_json)
            }

        private var validated: Boolean = false

        fun validate(): Updates =
            apply {
                if (validated) {
                  return@apply
                }
                ...
                accept(object : Visitor<Unit> {
                    ...
                    override fun visitEquipmentManagerUpdate(equipmentManagerUpdate: EquipmentManagerUpdate) {
        ...
        internal fun validity(): Int =
            accept(object : Visitor<Int> {
                override fun visitPlayerUpdate(playerUpdate: PlayerUpdate) = playerUpdate.validity()

                override fun visitCoachUpdate(coachUpdate: CoachUpdate) = coachUpdate.validity()

                override fun visitMedicalStaffUpdate(medicalStaffUpdate: MedicalStaffUpdate) = medicalStaffUpdate.validity()

                override fun visitEquipmentManagerUpdate(equipmentManagerUpdate: EquipmentManagerUpdate) = equipmentManagerUpdate.validity()
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Updates && playerUpdate == other.playerUpdate && coachUpdate == other.coachUpdate && medicalStaffUpdate == other.medicalStaffUpdate && equipmentManagerUpdate == other.equipmentManagerUpdate
        }

        override fun hashCode(): Int = Objects.hash(playerUpdate, coachUpdate, medicalStaffUpdate, equipmentManagerUpdate)
        ...
        override fun toString(): String =
            when {
                ...
                equipmentManagerUpdate != null -> "Updates{equipmentManagerUpdate=$equipmentManagerUpdate}"
        ...
        companion object {
            ...
            /** Update model for medical staff. */
            fun ofMedicalStaffUpdate(medicalStaffUpdate: MedicalStaffUpdate) = Updates(medicalStaffUpdate = medicalStaffUpdate)

            /** Update model for equipment managers. */
            fun ofEquipmentManagerUpdate(equipmentManagerUpdate: EquipmentManagerUpdate) = Updates(equipmentManagerUpdate = equipmentManagerUpdate)
        }
        ...
        interface Visitor<out T> {
             ...
             *
             * An instance of [Updates] can contain an unknown variant if it was deserialized from data
        ...
        internal class Deserializer : BaseDeserializer<Updates>(Updates::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Updates {
              ...
              val bestMatches = sequenceOf(
                      tryDeserialize(node, jacksonTypeRef<PlayerUpdate>())
                          ?.let {
                              Updates(playerUpdate = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<CoachUpdate>())
                          ?.let {
                              Updates(coachUpdate = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<MedicalStaffUpdate>())
                          ?.let {
                              Updates(medicalStaffUpdate = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<EquipmentManagerUpdate>())
                          ?.let {
        ...
        internal class Serializer : BaseSerializer<Updates>(Updates::class) {
            ...
            override fun serialize(value: Updates, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  ...
                  value.medicalStaffUpdate != null -> generator.writeObject(value.medicalStaffUpdate)
                  value.equipmentManagerUpdate != null -> generator.writeObject(value.equipmentManagerUpdate)
        ...
        /** Update model for players. */
        class PlayerUpdate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(playerUpdate: PlayerUpdate) =
                    apply {
                ...
                fun jerseyNumber(jerseyNumber: Long?) = jerseyNumber(JsonField.ofNullable(jerseyNumber))
                ...
                fun yearsWithTeam(yearsWithTeam: Long?) = yearsWithTeam(JsonField.ofNullable(yearsWithTeam))
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (assists.asKnown() == null) 0 else 1) + (if (goalsScored.asKnown() == null) 0 else 1) + (if (isCaptain.asKnown() == null) 0 else 1) + (if (jerseyNumber.asKnown() == null) 0 else 1) + (position.asKnown()?.validity() ?: 0) + (if (teamId.asKnown() == null) 0 else 1) + (if (yearsWithTeam.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PlayerUpdate && assists == other.assists && goalsScored == other.goalsScored && isCaptain == other.isCaptain && jerseyNumber == other.jerseyNumber && position == other.position && teamId == other.teamId && yearsWithTeam == other.yearsWithTeam && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(assists, goalsScored, isCaptain, jerseyNumber, position, teamId, yearsWithTeam, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "PlayerUpdate{assists=$assists, goalsScored=$goalsScored, isCaptain=$isCaptain, jerseyNumber=$jerseyNumber, position=$position, teamId=$teamId, yearsWithTeam=$yearsWithTeam, additionalProperties=$additionalProperties}"
        }

        /** Update model for coaches. */
        class CoachUpdate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(coachUpdate: CoachUpdate) =
                    apply {
                ...
                fun certifications(certifications: List<String>?) = certifications(JsonField.ofNullable(certifications))
                ...
                /** Coaching specialties. */
                fun specialty(specialty: CoachSpecialty?) = specialty(JsonField.ofNullable(specialty))
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (certifications.asKnown()?.size ?: 0) + (specialty.asKnown()?.validity() ?: 0) + (if (teamId.asKnown() == null) 0 else 1) + (if (winRate.asKnown() == null) 0 else 1) + (if (yearsWithTeam.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is CoachUpdate && certifications == other.certifications && specialty == other.specialty && teamId == other.teamId && winRate == other.winRate && yearsWithTeam == other.yearsWithTeam && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(certifications, specialty, teamId, winRate, yearsWithTeam, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "CoachUpdate{certifications=$certifications, specialty=$specialty, teamId=$teamId, winRate=$winRate, yearsWithTeam=$yearsWithTeam, additionalProperties=$additionalProperties}"
        }

        /** Update model for medical staff. */
        class MedicalStaffUpdate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(medicalStaffUpdate: MedicalStaffUpdate) =
                    apply {
                ...
                fun qualifications(qualifications: List<String>?) = qualifications(JsonField.ofNullable(qualifications))
                ...
                /** Medical staff specialties. */
                fun specialty(specialty: MedicalSpecialty?) = specialty(JsonField.ofNullable(specialty))
            ...
            fun validate(): MedicalStaffUpdate =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (licenseNumber.asKnown() == null) 0 else 1) + (qualifications.asKnown()?.size ?: 0) + (specialty.asKnown()?.validity() ?: 0) + (if (teamId.asKnown() == null) 0 else 1) + (if (yearsWithTeam.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is MedicalStaffUpdate && licenseNumber == other.licenseNumber && qualifications == other.qualifications && specialty == other.specialty && teamId == other.teamId && yearsWithTeam == other.yearsWithTeam && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(licenseNumber, qualifications, specialty, teamId, yearsWithTeam, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "MedicalStaffUpdate{licenseNumber=$licenseNumber, qualifications=$qualifications, specialty=$specialty, teamId=$teamId, yearsWithTeam=$yearsWithTeam, additionalProperties=$additionalProperties}"
        }

        /** Update model for equipment managers. */
        class EquipmentManagerUpdate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [EquipmentManagerUpdate]. */
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                internal fun from(equipmentManagerUpdate: EquipmentManagerUpdate) =
                    apply {
                        isHeadKitman = equipmentManagerUpdate.isHeadKitman
                        responsibilities = equipmentManagerUpdate.responsibilities.map { it.toMutableList() }
                        teamId = equipmentManagerUpdate.teamId
                        yearsWithTeam = equipmentManagerUpdate.yearsWithTeam
                        additionalProperties = equipmentManagerUpdate.additionalProperties.toMutableMap()
                    }

                fun isHeadKitman(isHeadKitman: Boolean?) = isHeadKitman(JsonField.ofNullable(isHeadKitman))
                ...
                fun responsibilities(responsibilities: List<String>?) = responsibilities(JsonField.ofNullable(responsibilities))
            ...
            fun validate(): EquipmentManagerUpdate =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (isHeadKitman.asKnown() == null) 0 else 1) + (responsibilities.asKnown()?.size ?: 0) + (if (teamId.asKnown() == null) 0 else 1) + (if (yearsWithTeam.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is EquipmentManagerUpdate && isHeadKitman == other.isHeadKitman && responsibilities == other.responsibilities && teamId == other.teamId && yearsWithTeam == other.yearsWithTeam && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(isHeadKitman, responsibilities, teamId, yearsWithTeam, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "EquipmentManagerUpdate{isHeadKitman=$isHeadKitman, responsibilities=$responsibilities, teamId=$teamId, yearsWithTeam=$yearsWithTeam, additionalProperties=$additionalProperties}"
        }
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamMemberUpdateParams && memberId == other.memberId && updates == other.updates && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(memberId, updates, additionalHeaders, additionalQueryParams)

    override fun toString() = "TeamMemberUpdateParams{memberId=$memberId, updates=$updates, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
