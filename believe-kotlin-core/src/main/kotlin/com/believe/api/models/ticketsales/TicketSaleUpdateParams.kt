...
class TicketSaleUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ticketSaleUpdateParams: TicketSaleUpdateParams) =
            apply {
        ...
        fun ticketSaleId(ticketSaleId: String?) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** How the ticket was purchased. */
            fun purchaseMethod(purchaseMethod: PurchaseMethod?) = purchaseMethod(JsonField.ofNullable(purchaseMethod))
         ...
         */
        internal fun validity(): Int = (if (buyerEmail.asKnown() == null) 0 else 1) + (if (buyerName.asKnown() == null) 0 else 1) + (if (couponCode.asKnown() == null) 0 else 1) + (if (currency.asKnown() == null) 0 else 1) + (if (discount.asKnown() == null) 0 else 1) + (if (matchId.asKnown() == null) 0 else 1) + (purchaseMethod.asKnown()?.validity() ?: 0) + (if (quantity.asKnown() == null) 0 else 1) + (if (subtotal.asKnown() == null) 0 else 1) + (if (tax.asKnown() == null) 0 else 1) + (if (total.asKnown() == null) 0 else 1) + (if (unitPrice.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && buyerEmail == other.buyerEmail && buyerName == other.buyerName && couponCode == other.couponCode && currency == other.currency && discount == other.discount && matchId == other.matchId && purchaseMethod == other.purchaseMethod && quantity == other.quantity && subtotal == other.subtotal && tax == other.tax && total == other.total && unitPrice == other.unitPrice && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(buyerEmail, buyerName, couponCode, currency, discount, matchId, purchaseMethod, quantity, subtotal, tax, total, unitPrice, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{buyerEmail=$buyerEmail, buyerName=$buyerName, couponCode=$couponCode, currency=$currency, discount=$discount, matchId=$matchId, purchaseMethod=$purchaseMethod, quantity=$quantity, subtotal=$subtotal, tax=$tax, total=$total, unitPrice=$unitPrice, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TicketSaleUpdateParams && ticketSaleId == other.ticketSaleId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(ticketSaleId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "TicketSaleUpdateParams{ticketSaleId=$ticketSaleId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
