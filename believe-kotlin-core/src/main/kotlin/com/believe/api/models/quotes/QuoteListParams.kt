...
class QuoteListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(quoteListParams: QuoteListParams) =
            apply {
        ...
        /** Filter inspirational quotes */
        fun inspirational(inspirational: Boolean?) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is QuoteListParams && characterId == other.characterId && funny == other.funny && inspirational == other.inspirational && limit == other.limit && momentType == other.momentType && skip == other.skip && theme == other.theme && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(characterId, funny, inspirational, limit, momentType, skip, theme, additionalHeaders, additionalQueryParams)

    override fun toString() = "QuoteListParams{characterId=$characterId, funny=$funny, inspirational=$inspirational, limit=$limit, momentType=$momentType, skip=$skip, theme=$theme, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
