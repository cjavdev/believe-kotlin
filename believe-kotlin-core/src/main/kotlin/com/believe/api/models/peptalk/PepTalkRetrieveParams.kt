...
class PepTalkRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(pepTalkRetrieveParams: PepTalkRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PepTalkRetrieveParams && stream == other.stream && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(stream, additionalHeaders, additionalQueryParams)

    override fun toString() = "PepTalkRetrieveParams{stream=$stream, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
