...
class BiscuitListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    private val data: JsonField<List<Biscuit>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Biscuit>> = JsonMissing.of(),
    ...
    fun data(): List<Biscuit> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<Biscuit>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BiscuitListPageResponse].
         *
    ...
    /** A builder for [BiscuitListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Biscuit>>? = null
        ...
        internal fun from(biscuitListPageResponse: BiscuitListPageResponse) =
            apply {
                data = biscuitListPageResponse.data.map { it.toMutableList() }
                hasMore = biscuitListPageResponse.hasMore
                limit = biscuitListPageResponse.limit
                page = biscuitListPageResponse.page
                pages = biscuitListPageResponse.pages
                skip = biscuitListPageResponse.skip
                total = biscuitListPageResponse.total
                additionalProperties = biscuitListPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<Biscuit>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Biscuit>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Biscuit>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        /**
         * Adds a single [Biscuit] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Biscuit) =
            apply {
        ...
        /**
         * Returns an immutable instance of [BiscuitListPageResponse].
         *
         ...
         */
        fun build(): BiscuitListPageResponse =
            BiscuitListPageResponse(
              checkRequired(
                "data", data
              ).map { it.toImmutable() },
              checkRequired(
    ...
    fun validate(): BiscuitListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BiscuitListPageResponse && data == other.data && hasMore == other.hasMore && limit == other.limit && page == other.page && pages == other.pages && skip == other.skip && total == other.total && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "BiscuitListPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
