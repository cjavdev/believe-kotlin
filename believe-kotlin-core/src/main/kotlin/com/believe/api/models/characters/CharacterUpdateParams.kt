...
class CharacterUpdateParams private constructor(
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         * @throws BelieveInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun emotionalStats(): EmotionalStats? = emotionalStats.getNullable("emotional_stats")
        ...
        /** @throws BelieveInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun personalityTraits(): List<String>? = personalityTraits.getNullable("personality_traits")
         ...
         * @throws BelieveInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun role(): CharacterRole? = role.getNullable("role")
        ...
        class Builder internal constructor() {
            ...
            private var emotionalStats: JsonField<EmotionalStats> = JsonMissing.of()
            ...
            private var role: JsonField<CharacterRole> = JsonMissing.of()
         ...
         */
        internal fun validity(): Int = (if (background.asKnown() == null) 0 else 1) + (if (dateOfBirth.asKnown() == null) 0 else 1) + (if (email.asKnown() == null) 0 else 1) + (emotionalStats.asKnown()?.validity() ?: 0) + (growthArcs.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (heightMeters.asKnown() == null) 0 else 1) + (if (name.asKnown() == null) 0 else 1) + (personalityTraits.asKnown()?.size ?: 0) + (if (profileImageUrl.asKnown() == null) 0 else 1) + (role.asKnown()?.validity() ?: 0) + (salaryGbp.asKnown()?.validity() ?: 0) + (signatureQuotes.asKnown()?.size ?: 0) + (if (teamId.asKnown() == null) 0 else 1)
