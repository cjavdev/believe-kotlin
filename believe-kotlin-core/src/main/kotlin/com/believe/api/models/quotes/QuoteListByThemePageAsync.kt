...
class QuoteListByThemePageAsync private constructor(
    ...
    override suspend fun nextPage(): QuoteListByThemePageAsync = service.listByTheme(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(quoteListByThemePageAsync: QuoteListByThemePageAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is QuoteListByThemePageAsync && service == other.service && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, params, response)

    override fun toString() = "QuoteListByThemePageAsync{service=$service, params=$params, response=$response}"
}
