 ...
 *
 */
class WTestParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(wTestParams: WTestParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is WTestParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(additionalHeaders, additionalQueryParams)

    override fun toString() = "WTestParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
