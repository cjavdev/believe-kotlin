...
class TeamMemberListCoachesPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    private val data: JsonField<List<Coach>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Coach>> = JsonMissing.of(),
    ...
    fun data(): List<Coach> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<Coach>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TeamMemberListCoachesPageResponse].
         *
    ...
    /** A builder for [TeamMemberListCoachesPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Coach>>? = null
        ...
        internal fun from(teamMemberListCoachesPageResponse: TeamMemberListCoachesPageResponse) =
            apply {
                data = teamMemberListCoachesPageResponse.data.map { it.toMutableList() }
                hasMore = teamMemberListCoachesPageResponse.hasMore
                limit = teamMemberListCoachesPageResponse.limit
                page = teamMemberListCoachesPageResponse.page
                pages = teamMemberListCoachesPageResponse.pages
                skip = teamMemberListCoachesPageResponse.skip
                total = teamMemberListCoachesPageResponse.total
                additionalProperties = teamMemberListCoachesPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<Coach>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Coach>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Coach>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        /**
         * Adds a single [Coach] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Coach) =
            apply {
        ...
        /**
         * Returns an immutable instance of [TeamMemberListCoachesPageResponse].
         *
         ...
         */
        fun build(): TeamMemberListCoachesPageResponse =
    ...
    fun validate(): TeamMemberListCoachesPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamMemberListCoachesPageResponse && data == other.data && hasMore == other.hasMore && limit == other.limit && page == other.page && pages == other.pages && skip == other.skip && total == other.total && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "TeamMemberListCoachesPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
