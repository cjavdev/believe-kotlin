...
class TeamMemberListCoachesPageResponse
...
private constructor(
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Coach>> = data
    ...
    class Builder internal constructor() {
        ...
        internal fun from(teamMemberListCoachesPageResponse: TeamMemberListCoachesPageResponse) =
            apply {
                ...
                additionalProperties =
                    teamMemberListCoachesPageResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Coach>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Coach>>) = apply {
    ...
    fun validate(): TeamMemberListCoachesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TeamMemberListCoachesPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "TeamMemberListCoachesPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
