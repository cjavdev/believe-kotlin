...
class CoachingPrinciple @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("application") @ExcludeMissing application: JsonField<String> = JsonMissing.of(),
        @JsonProperty("example_from_show") @ExcludeMissing exampleFromShow: JsonField<String> = JsonMissing.of(),
        @JsonProperty("explanation") @ExcludeMissing explanation: JsonField<String> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _application(): JsonField<String> = application
    ...
    @ExcludeMissing
    fun _principle(): JsonField<String> = principle
     ...
     */
    @JsonProperty("ted_quote")
    @ExcludeMissing
    fun _tedQuote(): JsonField<String> = tedQuote
    ...
    class Builder internal constructor() {
        ...
        internal fun from(coachingPrinciple: CoachingPrinciple) =
            apply {
         ...
         *
         * You should usually call [Builder.application] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun application(application: JsonField<String>) =
            apply {
                this.application = application
            }

        /** Example from the show */
        fun exampleFromShow(exampleFromShow: String) = exampleFromShow(JsonField.of(exampleFromShow))

        /**
         * Sets [Builder.exampleFromShow] to an arbitrary JSON value.
         *
         * You should usually call [Builder.exampleFromShow] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun exampleFromShow(exampleFromShow: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.explanation] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.principle] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun principle(principle: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.tedQuote] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tedQuote(tedQuote: JsonField<String>) =
            apply {
                this.tedQuote = tedQuote
            }
        ...
        fun build(): CoachingPrinciple =
            CoachingPrinciple(
              ...
              checkRequired(
                "exampleFromShow", exampleFromShow
              ),
              checkRequired(
    ...
    fun validate(): CoachingPrinciple =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (application.asKnown() == null) 0 else 1) + (if (exampleFromShow.asKnown() == null) 0 else 1) + (if (explanation.asKnown() == null) 0 else 1) + (if (principle.asKnown() == null) 0 else 1) + (if (tedQuote.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CoachingPrinciple && id == other.id && application == other.application && exampleFromShow == other.exampleFromShow && explanation == other.explanation && principle == other.principle && tedQuote == other.tedQuote && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(id, application, exampleFromShow, explanation, principle, tedQuote, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "CoachingPrinciple{id=$id, application=$application, exampleFromShow=$exampleFromShow, explanation=$explanation, principle=$principle, tedQuote=$tedQuote, additionalProperties=$additionalProperties}"
}
