...
class TeamMemberListPlayersPageResponse
...
private constructor(
        ...
        internal fun from(teamMemberListPlayersPageResponse: TeamMemberListPlayersPageResponse) =
            apply {
                ...
                additionalProperties =
                    teamMemberListPlayersPageResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): TeamMemberListPlayersPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TeamMemberListPlayersPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "TeamMemberListPlayersPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
