...
class TeamMemberListPlayersPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    fun data(): List<Player> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<Player>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TeamMemberListPlayersPageResponse].
         *
    ...
    /** A builder for [TeamMemberListPlayersPageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(teamMemberListPlayersPageResponse: TeamMemberListPlayersPageResponse) =
            apply {
                data = teamMemberListPlayersPageResponse.data.map { it.toMutableList() }
                hasMore = teamMemberListPlayersPageResponse.hasMore
                limit = teamMemberListPlayersPageResponse.limit
                page = teamMemberListPlayersPageResponse.page
                pages = teamMemberListPlayersPageResponse.pages
                skip = teamMemberListPlayersPageResponse.skip
                total = teamMemberListPlayersPageResponse.total
                additionalProperties = teamMemberListPlayersPageResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Player>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Player>>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [TeamMemberListPlayersPageResponse].
         *
         ...
         */
        fun build(): TeamMemberListPlayersPageResponse =
    ...
    fun validate(): TeamMemberListPlayersPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamMemberListPlayersPageResponse && data == other.data && hasMore == other.hasMore && limit == other.limit && page == other.page && pages == other.pages && skip == other.skip && total == other.total && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "TeamMemberListPlayersPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
