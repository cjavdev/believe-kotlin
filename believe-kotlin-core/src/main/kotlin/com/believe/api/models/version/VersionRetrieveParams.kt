...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): VersionRetrieveParams =
            VersionRetrieveParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "VersionRetrieveParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
