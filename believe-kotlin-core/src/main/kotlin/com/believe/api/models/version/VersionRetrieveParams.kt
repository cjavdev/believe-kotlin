...
class VersionRetrieveParams private constructor(
    ...
    companion object {
        ...
        fun none(): VersionRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(versionRetrieveParams: VersionRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is VersionRetrieveParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(additionalHeaders, additionalQueryParams)

    override fun toString() = "VersionRetrieveParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
