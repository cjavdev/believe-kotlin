...
class MatchListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    private val data: JsonField<List<Match>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Match>> = JsonMissing.of(),
    ...
    fun data(): List<Match> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<Match>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MatchListPageResponse].
         *
    ...
    /** A builder for [MatchListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Match>>? = null
        ...
        internal fun from(matchListPageResponse: MatchListPageResponse) =
            apply {
                data = matchListPageResponse.data.map { it.toMutableList() }
                hasMore = matchListPageResponse.hasMore
                limit = matchListPageResponse.limit
                page = matchListPageResponse.page
                pages = matchListPageResponse.pages
                skip = matchListPageResponse.skip
                total = matchListPageResponse.total
                additionalProperties = matchListPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<Match>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Match>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Match>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        /**
         * Adds a single [Match] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Match) =
            apply {
        ...
        /**
         * Returns an immutable instance of [MatchListPageResponse].
         *
         ...
         */
        fun build(): MatchListPageResponse =
            MatchListPageResponse(
              checkRequired(
                "data", data
              ).map { it.toImmutable() },
              checkRequired(
    ...
    fun validate(): MatchListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is MatchListPageResponse && data == other.data && hasMore == other.hasMore && limit == other.limit && page == other.page && pages == other.pages && skip == other.skip && total == other.total && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "MatchListPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
