...
private constructor(
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Match>> = data
    ...
    class Builder internal constructor() {
        ...
        internal fun from(matchListPageResponse: MatchListPageResponse) = apply {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Match>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Match>>) = apply {
    ...
    fun validate(): MatchListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MatchListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MatchListPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
