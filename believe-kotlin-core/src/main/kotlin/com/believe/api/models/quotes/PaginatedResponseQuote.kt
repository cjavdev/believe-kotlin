...
class PaginatedResponseQuote @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<Quote>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaginatedResponseQuote].
         *
    ...
    /** A builder for [PaginatedResponseQuote]. */
    class Builder internal constructor() {
        ...
        internal fun from(paginatedResponseQuote: PaginatedResponseQuote) =
            apply {
                data = paginatedResponseQuote.data.map { it.toMutableList() }
                hasMore = paginatedResponseQuote.hasMore
                limit = paginatedResponseQuote.limit
                page = paginatedResponseQuote.page
                pages = paginatedResponseQuote.pages
                skip = paginatedResponseQuote.skip
                total = paginatedResponseQuote.total
                additionalProperties = paginatedResponseQuote.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Quote>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Quote>>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [PaginatedResponseQuote].
         *
         ...
         */
        fun build(): PaginatedResponseQuote =
    ...
    fun validate(): PaginatedResponseQuote =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaginatedResponseQuote && data == other.data && hasMore == other.hasMore && limit == other.limit && page == other.page && pages == other.pages && skip == other.skip && total == other.total && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PaginatedResponseQuote{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
