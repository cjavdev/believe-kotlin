...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paginatedResponseQuote: PaginatedResponseQuote) = apply {
    ...
    fun validate(): PaginatedResponseQuote = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaginatedResponseQuote &&
            data == other.data &&
    ...
    override fun toString() =
        "PaginatedResponseQuote{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
