...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(characterListPageResponse: CharacterListPageResponse) = apply {
    ...
    fun validate(): CharacterListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CharacterListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CharacterListPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
