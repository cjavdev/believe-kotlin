...
class CharacterListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<Character>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CharacterListPageResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(characterListPageResponse: CharacterListPageResponse) =
            apply {
                data = characterListPageResponse.data.map { it.toMutableList() }
                hasMore = characterListPageResponse.hasMore
                limit = characterListPageResponse.limit
                page = characterListPageResponse.page
                pages = characterListPageResponse.pages
                skip = characterListPageResponse.skip
                total = characterListPageResponse.total
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Character>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Character>>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [CharacterListPageResponse].
         *
         ...
         */
        fun build(): CharacterListPageResponse =
    ...
    fun validate(): CharacterListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CharacterListPageResponse && data == other.data && hasMore == other.hasMore && limit == other.limit && page == other.page && pages == other.pages && skip == other.skip && total == other.total && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CharacterListPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
