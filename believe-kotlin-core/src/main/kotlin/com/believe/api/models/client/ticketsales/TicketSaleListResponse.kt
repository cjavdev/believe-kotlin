...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TicketSaleListResponse].
         *
    ...
    /** A builder for [TicketSaleListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(ticketSaleListResponse: TicketSaleListResponse) = apply {
            id = ticketSaleListResponse.id
            buyerName = ticketSaleListResponse.buyerName
            currency = ticketSaleListResponse.currency
            discount = ticketSaleListResponse.discount
            matchId = ticketSaleListResponse.matchId
            purchaseMethod = ticketSaleListResponse.purchaseMethod
            quantity = ticketSaleListResponse.quantity
            subtotal = ticketSaleListResponse.subtotal
            tax = ticketSaleListResponse.tax
            total = ticketSaleListResponse.total
            unitPrice = ticketSaleListResponse.unitPrice
            buyerEmail = ticketSaleListResponse.buyerEmail
            couponCode = ticketSaleListResponse.couponCode
            additionalProperties = ticketSaleListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TicketSaleListResponse].
         *
         ...
         */
        fun build(): TicketSaleListResponse =
    ...
    fun validate(): TicketSaleListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TicketSaleListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "TicketSaleListResponse{id=$id, buyerName=$buyerName, currency=$currency, discount=$discount, matchId=$matchId, purchaseMethod=$purchaseMethod, quantity=$quantity, subtotal=$subtotal, tax=$tax, total=$total, unitPrice=$unitPrice, buyerEmail=$buyerEmail, couponCode=$couponCode, additionalProperties=$additionalProperties}"
}
