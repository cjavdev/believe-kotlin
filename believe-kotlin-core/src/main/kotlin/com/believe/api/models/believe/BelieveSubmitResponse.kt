...
class BelieveSubmitResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
     ...
     */
    internal fun validity(): Int = (if (actionSuggestion.asKnown() == null) 0 else 1) + (if (believeScore.asKnown() == null) 0 else 1) + (if (goldfishWisdom.asKnown() == null) 0 else 1) + (if (relevantQuote.asKnown() == null) 0 else 1) + (if (tedResponse.asKnown() == null) 0 else 1)
