...
class QuoteGetRandomParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(quoteGetRandomParams: QuoteGetRandomParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is QuoteGetRandomParams && characterId == other.characterId && inspirational == other.inspirational && theme == other.theme && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(characterId, inspirational, theme, additionalHeaders, additionalQueryParams)

    override fun toString() = "QuoteGetRandomParams{characterId=$characterId, inspirational=$inspirational, theme=$theme, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
