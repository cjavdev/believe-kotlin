...
class BelieveSubmitParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(believeSubmitParams: BelieveSubmitParams) =
            apply {
        ...
        /** Describe your situation */
        fun situation(situation: String) =
            apply {
         ...
         *
         * You should usually call [Builder.situation] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun situation(situation: JsonField<String>) =
            apply {
                body.situation(situation)
            }
         ...
         *
         * You should usually call [Builder.situationType] with a well-typed [SituationType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun situationType(situationType: JsonField<SituationType>) =
            apply {
                body.situationType(situationType)
            }
         ...
         *
         * You should usually call [Builder.intensity] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun intensity(intensity: JsonField<Long>) =
            apply {
                body.intensity(intensity)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("situation") @ExcludeMissing situation: JsonField<String> = JsonMissing.of(),
            @JsonProperty("situation_type") @ExcludeMissing situationType: JsonField<SituationType> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _situation(): JsonField<String> = situation
        ...
        @ExcludeMissing
        fun _intensity(): JsonField<Long> = intensity
        ...
        class Builder internal constructor() {
            ...
            /** Type of situation */
            fun situationType(situationType: SituationType) = situationType(JsonField.of(situationType))
         ...
         */
        internal fun validity(): Int = (if (situation.asKnown() == null) 0 else 1) + (situationType.asKnown()?.validity() ?: 0) + (if (context.asKnown() == null) 0 else 1) + (if (intensity.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && situation == other.situation && situationType == other.situationType && context == other.context && intensity == other.intensity && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(situation, situationType, context, intensity, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{situation=$situation, situationType=$situationType, context=$context, intensity=$intensity, additionalProperties=$additionalProperties}"
    }

    /** Type of situation */
    class SituationType @JsonCreator private constructor(
        ...
        enum class Value {
            ...
            NEW_BEGINNING,
            RELATIONSHIP,
            /** An enum member indicating that [SituationType] was instantiated with an unknown value. */
            _UNKNOWN,
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BelieveSubmitParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "BelieveSubmitParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
