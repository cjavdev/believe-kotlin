...
class WebhookCreateParams private constructor(
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        internal fun validity(): Int = (if (url.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (eventTypes.asKnown()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && url == other.url && description == other.description && eventTypes == other.eventTypes && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(url, description, eventTypes, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{url=$url, description=$description, eventTypes=$eventTypes, additionalProperties=$additionalProperties}"
    }
