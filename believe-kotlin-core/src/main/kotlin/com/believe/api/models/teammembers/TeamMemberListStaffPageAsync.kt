...
class TeamMemberListStaffPageAsync private constructor(
     ...
     */
    fun data(): List<TeamMemberListStaffResponse> = response._data().getNullable("data") ?: emptyList()
    ...
    override suspend fun nextPage(): TeamMemberListStaffPageAsync = service.listStaff(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(teamMemberListStaffPageAsync: TeamMemberListStaffPageAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamMemberListStaffPageAsync && service == other.service && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, params, response)

    override fun toString() = "TeamMemberListStaffPageAsync{service=$service, params=$params, response=$response}"
}
