...
class TeamMemberListStaffPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    private val data: JsonField<List<TeamMemberListStaffResponse>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<TeamMemberListStaffResponse>> = JsonMissing.of(),
    ...
    fun data(): List<TeamMemberListStaffResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<TeamMemberListStaffResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TeamMemberListStaffPageResponse].
         *
    ...
    /** A builder for [TeamMemberListStaffPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<TeamMemberListStaffResponse>>? = null
        ...
        internal fun from(teamMemberListStaffPageResponse: TeamMemberListStaffPageResponse) =
            apply {
                data = teamMemberListStaffPageResponse.data.map { it.toMutableList() }
                hasMore = teamMemberListStaffPageResponse.hasMore
                limit = teamMemberListStaffPageResponse.limit
                page = teamMemberListStaffPageResponse.page
                pages = teamMemberListStaffPageResponse.pages
                skip = teamMemberListStaffPageResponse.skip
                total = teamMemberListStaffPageResponse.total
                additionalProperties = teamMemberListStaffPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<TeamMemberListStaffResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<TeamMemberListStaffResponse>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<TeamMemberListStaffResponse>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        /**
         * Adds a single [TeamMemberListStaffResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: TeamMemberListStaffResponse) =
            apply {
        ...
        /** Alias for calling [addData] with `TeamMemberListStaffResponse.ofMedicalStaff(medicalStaff)`. */
        fun addData(medicalStaff: MedicalStaff) = addData(TeamMemberListStaffResponse.ofMedicalStaff(medicalStaff))

        /** Alias for calling [addData] with `TeamMemberListStaffResponse.ofEquipmentManager(equipmentManager)`. */
        fun addData(equipmentManager: EquipmentManager) = addData(TeamMemberListStaffResponse.ofEquipmentManager(equipmentManager))
        ...
        /**
         * Returns an immutable instance of [TeamMemberListStaffPageResponse].
         *
         ...
         */
        fun build(): TeamMemberListStaffPageResponse =
    ...
    fun validate(): TeamMemberListStaffPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamMemberListStaffPageResponse && data == other.data && hasMore == other.hasMore && limit == other.limit && page == other.page && pages == other.pages && skip == other.skip && total == other.total && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "TeamMemberListStaffPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
