...
class RegisteredWebhook @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("event_types") @ExcludeMissing eventTypes: JsonField<List<EventType>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(registeredWebhook: RegisteredWebhook) =
            apply {
         ...
         *
         * You should usually call [Builder.eventTypes] with a well-typed `List<EventType>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun eventTypes(eventTypes: JsonField<List<EventType>>) =
            apply {
        ...
        fun addEventType(eventType: EventType) =
            apply {
                eventTypes = (eventTypes ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.secret] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
    ...
    fun validate(): RegisteredWebhook =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (eventTypes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (secret.asKnown() == null) 0 else 1) + (if (url.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RegisteredWebhook && id == other.id && createdAt == other.createdAt && eventTypes == other.eventTypes && secret == other.secret && url == other.url && description == other.description && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(id, createdAt, eventTypes, secret, url, description, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "RegisteredWebhook{id=$id, createdAt=$createdAt, eventTypes=$eventTypes, secret=$secret, url=$url, description=$description, additionalProperties=$additionalProperties}"
}
