...
class HealthCheckResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(healthCheckResponse: HealthCheckResponse) =
            apply {
    ...
    fun validate(): HealthCheckResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is HealthCheckResponse && additionalProperties == other.additionalProperties
    }
