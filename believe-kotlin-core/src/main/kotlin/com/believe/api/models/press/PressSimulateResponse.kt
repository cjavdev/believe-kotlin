...
class PressSimulateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("actual_wisdom") @ExcludeMissing actualWisdom: JsonField<String> = JsonMissing.of(),
        @JsonProperty("follow_up_dodge") @ExcludeMissing followUpDodge: JsonField<String> = JsonMissing.of(),
        @JsonProperty("reporter_reaction") @ExcludeMissing reporterReaction: JsonField<String> = JsonMissing.of(),
        @JsonProperty("response") @ExcludeMissing response: JsonField<String> = JsonMissing.of(),
        @JsonProperty("deflection_humor") @ExcludeMissing deflectionHumor: JsonField<String> = JsonMissing.of()
    ) : this(
      actualWisdom,
      followUpDodge,
      reporterReaction,
     ...
     *
     * Unlike [reporterReaction], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(pressSimulateResponse: PressSimulateResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.actualWisdom] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun actualWisdom(actualWisdom: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.followUpDodge] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun followUpDodge(followUpDodge: JsonField<String>) =
            apply {
                this.followUpDodge = followUpDodge
            }

        /** How reporters would react */
        fun reporterReaction(reporterReaction: String) = reporterReaction(JsonField.of(reporterReaction))

        /**
         * Sets [Builder.reporterReaction] to an arbitrary JSON value.
         *
         * You should usually call [Builder.reporterReaction] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reporterReaction(reporterReaction: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.response] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Humorous deflection if appropriate */
        fun deflectionHumor(deflectionHumor: String?) = deflectionHumor(JsonField.ofNullable(deflectionHumor))

        /**
         * Sets [Builder.deflectionHumor] to an arbitrary JSON value.
         *
         * You should usually call [Builder.deflectionHumor] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun deflectionHumor(deflectionHumor: JsonField<String>) =
            apply {
        ...
        fun build(): PressSimulateResponse =
            PressSimulateResponse(
              checkRequired(
                "actualWisdom", actualWisdom
              ),
              checkRequired(
                "followUpDodge", followUpDodge
              ),
              checkRequired(
                "reporterReaction", reporterReaction
              ),
              checkRequired(
                "response", response
              ),
    ...
    fun validate(): PressSimulateResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (actualWisdom.asKnown() == null) 0 else 1) + (if (followUpDodge.asKnown() == null) 0 else 1) + (if (reporterReaction.asKnown() == null) 0 else 1) + (if (response.asKnown() == null) 0 else 1) + (if (deflectionHumor.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PressSimulateResponse && actualWisdom == other.actualWisdom && followUpDodge == other.followUpDodge && reporterReaction == other.reporterReaction && response == other.response && deflectionHumor == other.deflectionHumor && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(actualWisdom, followUpDodge, reporterReaction, response, deflectionHumor, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "PressSimulateResponse{actualWisdom=$actualWisdom, followUpDodge=$followUpDodge, reporterReaction=$reporterReaction, response=$response, deflectionHumor=$deflectionHumor, additionalProperties=$additionalProperties}"
}
