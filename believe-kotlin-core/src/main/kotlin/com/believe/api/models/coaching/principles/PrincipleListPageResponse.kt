...
class PrincipleListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    private val data: JsonField<List<CoachingPrinciple>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<CoachingPrinciple>> = JsonMissing.of(),
    ...
    fun data(): List<CoachingPrinciple> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<CoachingPrinciple>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PrincipleListPageResponse].
         *
    ...
    /** A builder for [PrincipleListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<CoachingPrinciple>>? = null
        ...
        internal fun from(principleListPageResponse: PrincipleListPageResponse) =
            apply {
                data = principleListPageResponse.data.map { it.toMutableList() }
                hasMore = principleListPageResponse.hasMore
                limit = principleListPageResponse.limit
                page = principleListPageResponse.page
                pages = principleListPageResponse.pages
                skip = principleListPageResponse.skip
                total = principleListPageResponse.total
                additionalProperties = principleListPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<CoachingPrinciple>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CoachingPrinciple>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CoachingPrinciple>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        /**
         * Adds a single [CoachingPrinciple] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CoachingPrinciple) =
            apply {
        ...
        /**
         * Returns an immutable instance of [PrincipleListPageResponse].
         *
         ...
         */
        fun build(): PrincipleListPageResponse =
            PrincipleListPageResponse(
              checkRequired(
                "data", data
              ).map { it.toImmutable() },
              checkRequired(
    ...
    fun validate(): PrincipleListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PrincipleListPageResponse && data == other.data && hasMore == other.hasMore && limit == other.limit && page == other.page && pages == other.pages && skip == other.skip && total == other.total && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PrincipleListPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
