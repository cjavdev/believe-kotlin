...
class PrincipleListPageResponse
...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CoachingPrinciple>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CoachingPrinciple>> = data
    ...
    class Builder internal constructor() {
        ...
        internal fun from(principleListPageResponse: PrincipleListPageResponse) = apply {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<CoachingPrinciple>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CoachingPrinciple>>) = apply {
         ...
         */
        fun addData(data: CoachingPrinciple) = apply {
            this.data =
    ...
    fun validate(): PrincipleListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PrincipleListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "PrincipleListPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
