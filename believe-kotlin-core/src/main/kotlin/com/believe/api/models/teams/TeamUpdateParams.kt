...
class TeamUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(teamUpdateParams: TeamUpdateParams) =
            apply {
         ...
         *
         * You should usually call [Builder.annualBudgetGbp] with a well-typed [AnnualBudgetGbp] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun annualBudgetGbp(annualBudgetGbp: JsonField<AnnualBudgetGbp>) =
            apply {
                body.annualBudgetGbp(annualBudgetGbp)
            }

        /** Alias for calling [annualBudgetGbp] with `AnnualBudgetGbp.ofDouble(double)`. */
        fun annualBudgetGbp(double: Double) =
            apply {
                body.annualBudgetGbp(double)
            }

        /** Alias for calling [annualBudgetGbp] with `AnnualBudgetGbp.ofString(string)`. */
        fun annualBudgetGbp(string: String) =
            apply {
                body.annualBudgetGbp(string)
            }
        ...
        fun cultureScore(cultureScore: Long?) =
            apply {
                body.cultureScore(cultureScore)
            }
        ...
        fun foundedYear(foundedYear: Long?) =
            apply {
                body.foundedYear(foundedYear)
            }
        ...
        fun rivalTeams(rivalTeams: List<String>?) =
            apply {
                body.rivalTeams(rivalTeams)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("annual_budget_gbp") @ExcludeMissing annualBudgetGbp: JsonField<AnnualBudgetGbp> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            fun annualBudgetGbp(annualBudgetGbp: AnnualBudgetGbp?) = annualBudgetGbp(JsonField.ofNullable(annualBudgetGbp))
         ...
         */
        internal fun validity(): Int = (annualBudgetGbp.asKnown()?.validity() ?: 0) + (if (averageAttendance.asKnown() == null) 0 else 1) + (if (contactEmail.asKnown() == null) 0 else 1) + (if (cultureScore.asKnown() == null) 0 else 1) + (if (foundedYear.asKnown() == null) 0 else 1) + (if (isActive.asKnown() == null) 0 else 1) + (league.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1) + (if (nickname.asKnown() == null) 0 else 1) + (if (primaryColor.asKnown() == null) 0 else 1) + (rivalTeams.asKnown()?.size ?: 0) + (if (secondaryColor.asKnown() == null) 0 else 1) + (if (stadium.asKnown() == null) 0 else 1) + (stadiumLocation.asKnown()?.validity() ?: 0) + (values.asKnown()?.validity() ?: 0) + (if (website.asKnown() == null) 0 else 1) + (if (winPercentage.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && annualBudgetGbp == other.annualBudgetGbp && averageAttendance == other.averageAttendance && contactEmail == other.contactEmail && cultureScore == other.cultureScore && foundedYear == other.foundedYear && isActive == other.isActive && league == other.league && name == other.name && nickname == other.nickname && primaryColor == other.primaryColor && rivalTeams == other.rivalTeams && secondaryColor == other.secondaryColor && stadium == other.stadium && stadiumLocation == other.stadiumLocation && values == other.values && website == other.website && winPercentage == other.winPercentage && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(annualBudgetGbp, averageAttendance, contactEmail, cultureScore, foundedYear, isActive, league, name, nickname, primaryColor, rivalTeams, secondaryColor, stadium, stadiumLocation, values, website, winPercentage, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{annualBudgetGbp=$annualBudgetGbp, averageAttendance=$averageAttendance, contactEmail=$contactEmail, cultureScore=$cultureScore, foundedYear=$foundedYear, isActive=$isActive, league=$league, name=$name, nickname=$nickname, primaryColor=$primaryColor, rivalTeams=$rivalTeams, secondaryColor=$secondaryColor, stadium=$stadium, stadiumLocation=$stadiumLocation, values=$values, website=$website, winPercentage=$winPercentage, additionalProperties=$additionalProperties}"
    }

    @JsonDeserialize(using = AnnualBudgetGbp.Deserializer::class)
    @JsonSerialize(using = AnnualBudgetGbp.Serializer::class)
    class AnnualBudgetGbp private constructor(
        ...
        /** An interface that defines how to map each variant of [AnnualBudgetGbp] to a value of type [T]. */
        interface Visitor<out T> {
             ...
             *
             * An instance of [AnnualBudgetGbp] can contain an unknown variant if it was deserialized from data
        ...
        internal class Serializer : BaseSerializer<AnnualBudgetGbp>(AnnualBudgetGbp::class) {
            ...
            override fun serialize(value: AnnualBudgetGbp, generator: JsonGenerator, provider: SerializerProvider) {
              when {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamUpdateParams && teamId == other.teamId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(teamId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "TeamUpdateParams{teamId=$teamId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
