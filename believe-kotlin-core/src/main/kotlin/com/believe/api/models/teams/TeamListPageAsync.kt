...
class TeamListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(teamListPageAsync: TeamListPageAsync) =
            apply {
        ...
        fun service(service: TeamServiceAsync) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: TeamListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun response(response: TeamListPageResponse) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamListPageAsync && service == other.service && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, params, response)

    override fun toString() = "TeamListPageAsync{service=$service, params=$params, response=$response}"
}
