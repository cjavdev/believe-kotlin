...
class ReframeTransformNegativeThoughtsParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ReframeTransformNegativeThoughtsParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(reframeTransformNegativeThoughtsParams: ReframeTransformNegativeThoughtsParams) =
            apply {
                ...
                additionalQueryParams = reframeTransformNegativeThoughtsParams.additionalQueryParams.toBuilder()
            }
         ...
         *
         * You should usually call [Builder.negativeThought] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun negativeThought(negativeThought: JsonField<String>) =
            apply {
                body.negativeThought(negativeThought)
            }
         ...
         *
         * You should usually call [Builder.recurring] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun recurring(recurring: JsonField<Boolean>) =
            apply {
                body.recurring(recurring)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("negative_thought") @ExcludeMissing negativeThought: JsonField<String> = JsonMissing.of(),
            @JsonProperty("recurring") @ExcludeMissing recurring: JsonField<Boolean> = JsonMissing.of()
        ) : this(
          negativeThought,
          recurring,
          mutableMapOf(),
        ...
        @ExcludeMissing
        fun _recurring(): JsonField<Boolean> = recurring
        ...
        class Builder internal constructor() {
            ...
            /** The negative thought to reframe */
            fun negativeThought(negativeThought: String) = negativeThought(JsonField.of(negativeThought))
         ...
         */
        internal fun validity(): Int = (if (negativeThought.asKnown() == null) 0 else 1) + (if (recurring.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && negativeThought == other.negativeThought && recurring == other.recurring && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(negativeThought, recurring, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{negativeThought=$negativeThought, recurring=$recurring, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ReframeTransformNegativeThoughtsParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ReframeTransformNegativeThoughtsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
