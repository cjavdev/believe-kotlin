...
class TeamMemberListPlayersParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(teamMemberListPlayersParams: TeamMemberListPlayersParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamMemberListPlayersParams && limit == other.limit && position == other.position && skip == other.skip && teamId == other.teamId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(limit, position, skip, teamId, additionalHeaders, additionalQueryParams)

    override fun toString() = "TeamMemberListPlayersParams{limit=$limit, position=$position, skip=$skip, teamId=$teamId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
