...
private constructor(
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Team>> = data
    ...
    class Builder internal constructor() {
        ...
        internal fun from(teamListPageResponse: TeamListPageResponse) = apply {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Team>` value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<Team>>) = apply {
    ...
    fun validate(): TeamListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TeamListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "TeamListPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
