...
class TeamListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    private val data: JsonField<List<Team>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Team>> = JsonMissing.of(),
    ...
    fun data(): List<Team> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<Team>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TeamListPageResponse].
         *
    ...
    /** A builder for [TeamListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Team>>? = null
        ...
        internal fun from(teamListPageResponse: TeamListPageResponse) =
            apply {
                data = teamListPageResponse.data.map { it.toMutableList() }
                hasMore = teamListPageResponse.hasMore
                limit = teamListPageResponse.limit
                page = teamListPageResponse.page
                pages = teamListPageResponse.pages
                skip = teamListPageResponse.skip
                total = teamListPageResponse.total
                additionalProperties = teamListPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<Team>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Team>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Team>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        /**
         * Adds a single [Team] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Team) =
            apply {
        ...
        /**
         * Returns an immutable instance of [TeamListPageResponse].
         *
         ...
         */
        fun build(): TeamListPageResponse =
    ...
    fun validate(): TeamListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TeamListPageResponse && data == other.data && hasMore == other.hasMore && limit == other.limit && page == other.page && pages == other.pages && skip == other.skip && total == other.total && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "TeamListPageResponse{data=$data, hasMore=$hasMore, limit=$limit, page=$page, pages=$pages, skip=$skip, total=$total, additionalProperties=$additionalProperties}"
}
