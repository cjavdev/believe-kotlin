...
class PurchaseMethod @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    enum class Value {
        ...
        PHONE,
        /**
         * An enum member indicating that [PurchaseMethod] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
