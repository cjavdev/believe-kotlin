...
class TicketSaleUpdateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TicketSaleUpdateResponse].
         *
    ...
    /** A builder for [TicketSaleUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(ticketSaleUpdateResponse: TicketSaleUpdateResponse) = apply {
            id = ticketSaleUpdateResponse.id
            buyerName = ticketSaleUpdateResponse.buyerName
            currency = ticketSaleUpdateResponse.currency
            discount = ticketSaleUpdateResponse.discount
            matchId = ticketSaleUpdateResponse.matchId
            purchaseMethod = ticketSaleUpdateResponse.purchaseMethod
            quantity = ticketSaleUpdateResponse.quantity
            subtotal = ticketSaleUpdateResponse.subtotal
            tax = ticketSaleUpdateResponse.tax
            total = ticketSaleUpdateResponse.total
            unitPrice = ticketSaleUpdateResponse.unitPrice
            buyerEmail = ticketSaleUpdateResponse.buyerEmail
            couponCode = ticketSaleUpdateResponse.couponCode
            additionalProperties = ticketSaleUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TicketSaleUpdateResponse].
         *
         ...
         */
        fun build(): TicketSaleUpdateResponse =
    ...
    fun validate(): TicketSaleUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TicketSaleUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "TicketSaleUpdateResponse{id=$id, buyerName=$buyerName, currency=$currency, discount=$discount, matchId=$matchId, purchaseMethod=$purchaseMethod, quantity=$quantity, subtotal=$subtotal, tax=$tax, total=$total, unitPrice=$unitPrice, buyerEmail=$buyerEmail, couponCode=$couponCode, additionalProperties=$additionalProperties}"
}
