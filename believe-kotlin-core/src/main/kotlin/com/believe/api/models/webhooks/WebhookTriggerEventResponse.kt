...
class WebhookTriggerEventResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("deliveries") @ExcludeMissing deliveries: JsonField<List<Delivery>> = JsonMissing.of(),
        @JsonProperty("event_id") @ExcludeMissing eventId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("event_type") @ExcludeMissing eventType: JsonField<EventType> = JsonMissing.of(),
        @JsonProperty("successful_deliveries") @ExcludeMissing successfulDeliveries: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("ted_says") @ExcludeMissing tedSays: JsonField<String> = JsonMissing.of(),
        @JsonProperty("total_webhooks") @ExcludeMissing totalWebhooks: JsonField<Long> = JsonMissing.of()
    ) : this(
      deliveries,
      eventId,
      eventType,
     ...
     *
     * Unlike [successfulDeliveries], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookTriggerEventResponse: WebhookTriggerEventResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.deliveries] with a well-typed `List<Delivery>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun deliveries(deliveries: JsonField<List<Delivery>>) =
            apply {
        ...
        fun addDelivery(delivery: Delivery) =
            apply {
                deliveries = (deliveries ?: JsonField.of(mutableListOf())).also {
        ...
        /** Number of successful deliveries */
        fun successfulDeliveries(successfulDeliveries: Long) = successfulDeliveries(JsonField.of(successfulDeliveries))

        /**
         * Sets [Builder.successfulDeliveries] to an arbitrary JSON value.
         *
         * You should usually call [Builder.successfulDeliveries] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun successfulDeliveries(successfulDeliveries: JsonField<Long>) =
            apply {
         ...
         *
         * You should usually call [Builder.totalWebhooks] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun totalWebhooks(totalWebhooks: JsonField<Long>) =
            apply {
    ...
    fun validate(): WebhookTriggerEventResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (deliveries.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (eventId.asKnown() == null) 0 else 1) + (eventType.asKnown()?.validity() ?: 0) + (if (successfulDeliveries.asKnown() == null) 0 else 1) + (if (tedSays.asKnown() == null) 0 else 1) + (if (totalWebhooks.asKnown() == null) 0 else 1)

    /** Result of delivering a webhook to a single endpoint. */
    class Delivery @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @ExcludeMissing
        fun _webhookId(): JsonField<String> = webhookId
        ...
        @JsonProperty("error")
        @ExcludeMissing
        fun _error(): JsonField<String> = error
        ...
        class Builder internal constructor() {
            ...
            internal fun from(delivery: Delivery) =
                apply {
             ...
             *
             * You should usually call [Builder.success] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun success(success: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.webhookId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun webhookId(webhookId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.error] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.statusCode] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun statusCode(statusCode: JsonField<Long>) =
                apply {
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (success.asKnown() == null) 0 else 1) + (if (url.asKnown() == null) 0 else 1) + (if (webhookId.asKnown() == null) 0 else 1) + (if (error.asKnown() == null) 0 else 1) + (if (statusCode.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Delivery && success == other.success && url == other.url && webhookId == other.webhookId && error == other.error && statusCode == other.statusCode && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(success, url, webhookId, error, statusCode, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Delivery{success=$success, url=$url, webhookId=$webhookId, error=$error, statusCode=$statusCode, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is WebhookTriggerEventResponse && deliveries == other.deliveries && eventId == other.eventId && eventType == other.eventType && successfulDeliveries == other.successfulDeliveries && tedSays == other.tedSays && totalWebhooks == other.totalWebhooks && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(deliveries, eventId, eventType, successfulDeliveries, tedSays, totalWebhooks, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "WebhookTriggerEventResponse{deliveries=$deliveries, eventId=$eventId, eventType=$eventType, successfulDeliveries=$successfulDeliveries, tedSays=$tedSays, totalWebhooks=$totalWebhooks, additionalProperties=$additionalProperties}"
}
