...
class FileUpload @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("checksum_sha256") @ExcludeMissing checksumSha256: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("uploaded_at") @ExcludeMissing uploadedAt: JsonField<OffsetDateTime> = JsonMissing.of()
    ) : this(
      checksumSha256,
      contentType,
      fileId,
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileUpload: FileUpload) =
            apply {
         ...
         *
         * You should usually call [Builder.checksumSha256] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun checksumSha256(checksumSha256: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.sizeBytes] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sizeBytes(sizeBytes: JsonField<Long>) =
            apply {
         ...
         *
         * You should usually call [Builder.uploadedAt] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun uploadedAt(uploadedAt: JsonField<OffsetDateTime>) =
            apply {
     ...
     */
    internal fun validity(): Int = (if (checksumSha256.asKnown() == null) 0 else 1) + (if (contentType.asKnown() == null) 0 else 1) + (if (fileId.asKnown() == null) 0 else 1) + (if (filename.asKnown() == null) 0 else 1) + (if (sizeBytes.asKnown() == null) 0 else 1) + (if (uploadedAt.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is FileUpload && checksumSha256 == other.checksumSha256 && contentType == other.contentType && fileId == other.fileId && filename == other.filename && sizeBytes == other.sizeBytes && uploadedAt == other.uploadedAt && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(checksumSha256, contentType, fileId, filename, sizeBytes, uploadedAt, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "FileUpload{checksumSha256=$checksumSha256, contentType=$contentType, fileId=$fileId, filename=$filename, sizeBytes=$sizeBytes, uploadedAt=$uploadedAt, additionalProperties=$additionalProperties}"
}
