...
class WebhookRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookRetrieveParams: WebhookRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is WebhookRetrieveParams && webhookId == other.webhookId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(webhookId, additionalHeaders, additionalQueryParams)

    override fun toString() = "WebhookRetrieveParams{webhookId=$webhookId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
