...
class ConflictResolveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(conflictResolveParams: ConflictResolveParams) =
            apply {
        ...
        /** Type of conflict */
        fun conflictType(conflictType: ConflictType) =
            apply {
         ...
         *
         * You should usually call [Builder.conflictType] with a well-typed [ConflictType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun conflictType(conflictType: JsonField<ConflictType>) =
            apply {
                body.conflictType(conflictType)
            }
         ...
         *
         * You should usually call [Builder.partiesInvolved] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun partiesInvolved(partiesInvolved: JsonField<List<String>>) =
            apply {
                body.partiesInvolved(partiesInvolved)
            }
         ...
         */
        fun addPartiesInvolved(partiesInvolved: String) =
            apply {
         ...
         *
         * You should usually call [Builder.attemptsMade] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun attemptsMade(attemptsMade: JsonField<List<String>>) =
            apply {
                body.attemptsMade(attemptsMade)
            }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAttemptsMade(attemptsMade: String) =
            apply {
                body.addAttemptsMade(attemptsMade)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("conflict_type") @ExcludeMissing conflictType: JsonField<ConflictType> = JsonMissing.of(),
            @JsonProperty("description") @ExcludeMissing description: JsonField<String> = JsonMissing.of(),
            @JsonProperty("parties_involved") @ExcludeMissing partiesInvolved: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("attempts_made") @ExcludeMissing attemptsMade: JsonField<List<String>> = JsonMissing.of()
        ) : this(
          conflictType,
          description,
          partiesInvolved,
        ...
        class Builder internal constructor() {
            ...
            /** Who is involved in the conflict */
            fun partiesInvolved(partiesInvolved: List<String>) = partiesInvolved(JsonField.of(partiesInvolved))
            ...
            fun addPartiesInvolved(partiesInvolved: String) =
                apply {
                    this.partiesInvolved = (this.partiesInvolved ?: JsonField.of(mutableListOf())).also {
                        checkKnown("partiesInvolved", it).add(partiesInvolved)
                    }
                }

            /** What you've already tried */
            fun attemptsMade(attemptsMade: List<String>?) = attemptsMade(JsonField.ofNullable(attemptsMade))
            ...
            fun addAttemptsMade(attemptsMade: String) =
                apply {
                    this.attemptsMade = (this.attemptsMade ?: JsonField.of(mutableListOf())).also {
         ...
         */
        internal fun validity(): Int = (conflictType.asKnown()?.validity() ?: 0) + (if (description.asKnown() == null) 0 else 1) + (partiesInvolved.asKnown()?.size ?: 0) + (attemptsMade.asKnown()?.size ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && conflictType == other.conflictType && description == other.description && partiesInvolved == other.partiesInvolved && attemptsMade == other.attemptsMade && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(conflictType, description, partiesInvolved, attemptsMade, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{conflictType=$conflictType, description=$description, partiesInvolved=$partiesInvolved, attemptsMade=$attemptsMade, additionalProperties=$additionalProperties}"
    }

    /** Type of conflict */
    class ConflictType @JsonCreator private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ConflictResolveParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ConflictResolveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
