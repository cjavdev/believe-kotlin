...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.believe.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.believe.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.believe.api.** {
    <init>(...);
