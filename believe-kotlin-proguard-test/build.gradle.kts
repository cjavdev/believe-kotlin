...
dependencies {
    testImplementation(project(":believe-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../believe-kotlin-core/src/main/resources/META-INF/proguard/believe-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.believe.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../believe-kotlin-core/src/main/resources/META-INF/proguard/believe-kotlin-core.pro",
