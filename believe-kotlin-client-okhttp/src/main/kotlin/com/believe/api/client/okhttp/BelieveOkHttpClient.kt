...
/**
 * A class that allows building an instance of [BelieveClient] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class BelieveOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [BelieveClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): BelieveClient = builder().fromEnv().build()
    }

    /** A builder for [BelieveOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [BelieveClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BelieveClient =
            BelieveClientImpl(clientOptions
