...
/**
 * A class that allows building an instance of [BelieveClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class BelieveOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [BelieveClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): BelieveClientAsync = builder().fromEnv().build()
    }

    /** A builder for [BelieveOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [BelieveClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BelieveClientAsync =
            BelieveClientAsyncImpl(clientOptions
