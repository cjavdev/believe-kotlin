    ...
    publications {
        register<MavenPublication>("maven") {
            ...
            pom {
                ...
                url.set("https://www.github.com/cjavdev/believe-kotlin")
                ...
                scm {
                    connection.set("scm:git:git://github.com/cjavdev/believe-kotlin.git")
                    developerConnection.set("scm:git:git://github.com/cjavdev/believe-kotlin.git")
                    url.set("https://github.com/cjavdev/believe-kotlin")
                }
